    ...
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      ...
      <div className={`${T.cardBg} ${T.border} rounded-lg p-6 text-center`}>
        <div className="space-y-4">
          ...
          <h1 className={`${ds.h2} text-gray-900 text-white`}>Prenota {bookingTypeLabel}</h1>
          <p className={`${ds.bodyLg} text-gray-600 text-gray-400 max-w-2xl mx-auto`}>
      ...
      {user && affiliatedClubs.length > 0 && (
        <div className={`${T.cardBg} ${T.border} rounded-lg p-6`}>
          ...
          <p className={`${ds.bodySm} text-gray-600 text-gray-400 mb-4`}>
                ...
                >
                  <div className="space-y-3">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="bg-green-100 bg-green-900/30 text-green-800 text-green-400 px-2 py-1 rounded-full text-xs">
                        Affiliato
                      </span>
                    </div>
                    {club.location && (
                      <p className={`${ds.bodySm} text-gray-600 text-gray-400`}>
                        📍 {club.location.city}
        ...
        <div className={`${T.cardBg} ${T.border} rounded-lg p-6`}>
          ...
          {searchTerm && searchFilteredClubs.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className={`${ds.bodyLg} text-gray-600 text-gray-400`}>
