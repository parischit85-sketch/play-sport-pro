  ...
  return (
    <>
      ...
      <div
        ...
        className="bg-white bg-gray-800 rounded-xl shadow-2xl p-6 max-w-md animate-fade-in"
      >
        {/* Header */}
        ...
        {/* Progress bar */}
        <div className="w-full bg-gray-200 bg-gray-700 rounded-full h-2 mb-4">
          <div
        ...
        {/* Content */}
        <p className="text-gray-700 text-gray-300 mb-6 leading-relaxed">
          {currentStepData.content}
        </p>

        {/* Action hint */}
        {currentStepData.action && (
          <div className="bg-blue-50 bg-blue-900/20 border border-blue-200 border-blue-800 rounded-lg p-3 mb-6">
            <p className="text-sm text-blue-800 text-blue-300 font-medium">
              💡 {currentStepData.action}
            </p>
          </div>
        )}
        ...
        <div className="flex items-center justify-between gap-3">
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${
              isFirstStep
                ? 'bg-gray-100 bg-gray-700 text-gray-400 cursor-not-allowed'
                : 'bg-gray-200 bg-gray-700 text-gray-700 text-gray-300 hover:bg-gray-300 hover:bg-gray-600'
            }`}
          >
          ...
          <button
            onClick={handleSkip}
            className="px-4 py-2 text-gray-600 text-gray-400 hover:text-gray-900 hover:text-gray-200 font-medium transition-colors flex items-center gap-2"
          >
