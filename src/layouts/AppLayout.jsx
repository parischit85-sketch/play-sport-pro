              ...
              <div className="flex items-center gap-2 min-w-0">
                ...
                {club.logoUrl ? (
                  <img
                    src={club.logoUrl}
                    alt={`${club.name} logo`}
                    className="h-8 w-8 rounded-lg object-cover shadow-sm border border-gray-600/20"
                  />
                ) : (
                  <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-sm border border-gray-600/20">
                    <span className="text-white text-sm font-bold">🏓</span>
                  </div>
                )}
                <div
                  className="text-lg sm:text-2xl font-bold tracking-wide truncate text-white"
                  title={club?.name}
                >
                  {club.name}
                </div>
