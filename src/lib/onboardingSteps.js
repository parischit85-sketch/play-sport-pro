...
export const ONBOARDING_TOURS = {
  ...
  newUser: [
    {
      ...
      content: 'Questa è la tua dashboard personale. Qui puoi vedere le tue prenotazioni, statistiche e accedere a tutte le funzioni.',
      placement: 'bottom',
      highlightPadding: 10,
    },
    {
      ...
      content: 'Usa il menu per navigare tra le diverse sezioni: Prenota, Classifica, Tornei e Profilo.',
      placement: 'bottom',
      highlightPadding: 5,
    },
    {
      ...
      content: 'Clicca qui per prenotare un campo. Scegli data, orario e campo disponibile in pochi passaggi.',
      placement: 'left',
    ...
    },
    {
      ...
      title: '🔔 Notifiche',
      content: 'Ricevi notifiche per conferme prenotazioni, promemoria partite e aggiornamenti tornei.',
      placement: 'bottom',
    },
  ],
  ...
  clubAdmin: [
    ...
    },
    {
      ...
      content: 'Visualizza tutte le prenotazioni in tempo reale. Conferma, modifica o cancella prenotazioni.',
      placement: 'left',
    },
    {
  ...
  bookingFlow: [
    {
      ...
      content: 'Seleziona il club dove vuoi giocare. Puoi filtrare per città o salvare i tuoi club preferiti.',
      placement: 'bottom',
      highlightPadding: 8,
    },
    {
