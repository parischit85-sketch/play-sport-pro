                  ...
                  <div key={p.id} className={`rounded-xl ${T.cardBg} ${T.border} p-4`}>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        <div className="font-bold text-blue-600 text-blue-400">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => remove(p.id)}
                        className="px-4 py-2 text-sm bg-red-50 bg-red-900/20 text-red-600 text-red-400 border border-red-200 border-red-800 rounded-lg hover:bg-red-100 hover:bg-red-900/30 transition-colors"
                      >
                        🗑️
                      </button>
                    </div>
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      ...
                      <div className={`text-xs ${T.subtext}`}>
                        Ranking: {Number(liveRating).toFixed(2)}
                      </div>
                    </div>
