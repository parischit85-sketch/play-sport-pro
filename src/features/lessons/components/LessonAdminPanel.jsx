            ...
            <div className="space-y-4">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-sm text-yellow-700">
                  Questa sezione permette di cancellare tutte le prenotazioni di lezione di test. 
                  Le prenotazioni dei campi associate verranno anche cancellate automaticamente.
                </p>
              </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-red-50 border border-red-200 rounded p-3">
                      <p className="text-sm text-red-700">
                        <strong>Cosa verrà eliminato:</strong><br/>
                        • {lessonBookingsCount} prenotazione/i di lezione<br/>
                        • I relativi slot prenotati nei campi<br/>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex gap-3 pt-4">
          <button
            type="button"
            onClick={onClose}
            className={`flex-1 py-2 px-4 ${T.cardBg} ${T.border} ${T.borderMd} hover:bg-gray-50`}
          >
            Annulla
          </button>
          <button
            type="submit"
            className="flex-1 py-2 px-4 bg-blue-600 text-white hover:bg-blue-700"
          >
