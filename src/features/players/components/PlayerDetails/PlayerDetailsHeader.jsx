    ...
    <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900/20 border-b-2 border-gray-700">
      ...
      <div className="relative px-6 py-6">
        ...
        <div className="mb-6 relative z-20">
          <h2 id="player-details-title" className="text-3xl font-bold text-white mb-1 flex items-center gap-3">
            {player.firstName || player.lastName
              ? `${player.firstName || ''} ${player.lastName || ''}`.trim()
              : player.name || player.displayName || player.userName || 'Giocatore'}
            {pspId && (
              <span className="text-sm font-mono bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded border border-blue-500/30">
                #{pspId}
              </span>
            )}
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
          ...
          <div className="lg:col-span-5">
            <div className="grid grid-cols-3 gap-3 h-full">
              {/* Ranking Card */}
              <div className="bg-gradient-to-br from-purple-500 to-purple-600 from-purple-600 to-purple-700 rounded-xl p-4 text-white shadow-lg relative overflow-hidden">
              ...
              {/* Wallet Card */}
              <div className="bg-gradient-to-br from-green-500 to-green-600 from-green-600 to-green-700 rounded-xl p-4 text-white shadow-lg relative overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10"></div>
                <div className="relative">
              ...
              {/* Bookings Card */}
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 from-orange-600 to-orange-700 rounded-xl p-4 text-white shadow-lg relative overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10"></div>
                <div className="relative">
