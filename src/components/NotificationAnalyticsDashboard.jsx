        ...
        {funnelData && (
          <div className="chart-card funnel-card">
            ...
            <div className="funnel-stats">
              <p>Delivery Rate: <strong>{funnelData.rates.deliveryRate}</strong></p>
              <p>CTR: <strong>{funnelData.rates.ctr}</strong></p>
              <p>Conversion Rate: <strong>{funnelData.rates.conversionRate}</strong></p>
            </div>
          </div>
        )}
            ...
            <tbody>
              {channelPerformance.map(channel => (
                <tr key={channel.channel}>
                  <td>
                    <span className="channel-badge" style={{ backgroundColor: CHANNEL_COLORS[channel.channel] }}>
                      {channel.channel}
                    </span>
                  </td>
                  <td>{channel.sent}</td>
      ...
      {abTestResults && (
        <div className="ab-test-results-card">
          ...
          <div className="ab-test-summary">
            <p>Winner: <strong>{abTestResults.winner}</strong></p>
            <p>Confidence: <strong>{abTestResults.confidence}</strong></p>
            <p>Sample Size: <strong>{abTestResults.sampleSize}</strong></p>
          </div>
