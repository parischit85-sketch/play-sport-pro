    ...
    <div className="space-y-6">
      {canAssignGroups && (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Assegna Gironi Manualmente</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Seleziona il girone per ogni squadra (max {teamsPerGroup} per girone).</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            {teams.map((team) => (
              <div key={team.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-3 bg-gray-50 dark:bg-gray-900/30">
                <div className="font-medium text-gray-900 dark:text-white mb-2">{team.teamName}</div>
                <select
              ...
              {(team.averageRanking !== null && team.averageRanking !== undefined) && (
                <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500 dark:text-gray-400">Ranking Medio</span>
