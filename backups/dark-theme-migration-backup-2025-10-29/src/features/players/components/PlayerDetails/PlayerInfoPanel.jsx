...
const PlayerInfoPanel = ({ player, T }) => {
  ...
  return (
    <aside className="hidden xl:block w-80 flex-shrink-0 border-l border-gray-200 dark:border-gray-700 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800/50 dark:to-gray-900/50">
      <div className="sticky top-0 p-6 space-y-6 max-h-screen overflow-y-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-2xl">📅</span>
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Prenotazioni mese</div>
                  <div className="text-lg font-bold text-gray-900 dark:text-white">
        ...
        <div className="space-y-2 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <button className="w-full px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg text-xs font-semibold hover:shadow-md transition-shadow">
            📧 Invia Comunicazione
          </button>
        </div>
