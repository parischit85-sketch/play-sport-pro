...
import { TrendingUp, Calendar, Clock, Users, DollarSign, Download, X, Filter } from 'lucide-react';
...
const BookingAnalyticsDashboard = ({ isOpen, onClose, clubId }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white bg-gray-800 rounded-xl shadow-2xl w-full max-w-7xl max-h-[90vh] flex flex-col">
        {/* Header */}
        ...
        {/* Filters */}
        <div className="p-6 border-b border-gray-200 border-gray-700 bg-gray-50 bg-gray-900/50">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 border-gray-600 rounded-lg bg-white bg-gray-700 text-gray-900 text-white"
            >
            ...
            {dateRange === 'custom' && (
              <>
                <input
                  ...
                  className="px-4 py-2 border border-gray-300 border-gray-600 rounded-lg bg-white bg-gray-700 text-gray-900 text-white"
                />
                <span className="text-gray-600 text-gray-400">to</span>
                <input
                  type="date"
                  value={customEndDate}
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-medium bg-white/20 px-2 py-1 rounded">Count</span>
                  </div>
              ...
              <div className="bg-white bg-gray-700 rounded-xl p-6 border border-gray-200 border-gray-600">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200 border-gray-600">
                        <th className="text-left p-3 text-sm font-semibold text-gray-700 text-gray-300">
                          #
                        </th>
                        <th className="text-left p-3 text-sm font-semibold text-gray-700 text-gray-300">
                          User
                        </th>
                        <th className="text-right p-3 text-sm font-semibold text-gray-700 text-gray-300">
                          Bookings
                        </th>
                        <th className="text-right p-3 text-sm font-semibold text-gray-700 text-gray-300">
                          Revenue
                    ...
                    <tbody>
                      {analytics.topUsers.map((user, index) => (
                        ...
                        >
                          ...
                          <td className="p-3 text-sm text-gray-900 text-white text-right">
                            {user.count}
                          </td>
                          <td className="p-3 text-sm text-gray-900 text-white text-right font-medium">
