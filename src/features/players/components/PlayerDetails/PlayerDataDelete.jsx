    ...
    <div className="border-t border-gray-700 pt-6 mt-6">
      ...
      <div className="border-2 border-red-300 border-red-800 rounded-lg p-6 bg-red-50 bg-red-900/10">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="text-xl font-bold text-red-700 text-red-400 mb-2">
              Zona Pericolo - Cancellazione Permanente
            </h3>
            <p className="text-sm text-red-600 text-red-400 mb-1">
        ...
        {confirmStep === 1 && (
          <div>
            <div className="mb-4 p-4 bg-gray-800 border border-red-700 rounded-lg">
              ...
              <ul className="text-sm text-red-600 text-red-400 space-y-2 list-disc list-inside">
              ...
              <p className="text-sm text-red-700 text-red-400 font-bold mt-3">
        ...
        {confirmStep === 2 && (
          <div>
            <div className="mb-4 p-4 bg-gray-800 border-2 border-red-700 rounded-lg">
              ...
              <p className="text-base font-mono font-bold text-red-800 text-red-300 bg-red-100 bg-red-900/30 p-3 rounded mb-4 text-center">
