...
export default function PlayerTournamentTab({ player, onUpdate, T }) {
  ...
  const handleSave = () => {
    ...
    const tournamentData = {
      ...
      currentRanking: initialRankingChanged
        ? validInitialRanking
        : player.rating || validInitialRanking,
    ...
    onUpdate({
      ...
      ...(initialRankingChanged && {
        rating: validInitialRanking,
        baseRating: validInitialRanking,
      }),
    });
  };
  ...
  const rankingChange =
    stats.currentRanking && stats.initialRanking ? stats.currentRanking - stats.initialRanking : 0;
    ...
    <div className="space-y-6">
      ...
      <div className={`${T.cardBg} ${T.border} rounded-2xl p-6 shadow-lg relative overflow-hidden`}>
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-6">
            ...
            {formData.isParticipant && (
              <div className="flex flex-col items-end gap-2">
                ...
                {formData.isActive ? (
                  <div className="flex items-center gap-2 text-xs text-green-600 text-green-400 font-semibold">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                    In gara
                  </div>
                ) : (
                  <div className="flex items-center gap-2 text-xs text-orange-600 text-orange-400 font-semibold">
          ...
          <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 from-blue-900/20 via-indigo-900/20 to-purple-900/20 rounded-xl p-5 border-2 border-blue-200/50 border-blue-700/50 mb-6 hover:border-blue-300 hover:border-blue-600 transition-colors">
            <label className="flex items-center gap-4 cursor-pointer group">
                ...
                <div
                  className={`w-8 h-8 rounded-xl border-2 flex items-center justify-center transition-all duration-200 ${
                    formData.isParticipant
                      ...
                      : 'bg-white bg-gray-700 border-gray-300 border-gray-600 group-hover:border-blue-400 group-hover:scale-105'
                  }`}
                >
                  {formData.isParticipant && (
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <span
                    className={`${T.label} font-bold text-base ${formData.isParticipant ? 'text-blue-700 text-blue-300' : ''}`}
                  >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 ${T.input} rounded-lg border ${T.border} focus:ring-2 focus:ring-blue-500 focus:ring-blue-400`}
                  placeholder="1500"
                />
              ...
              {/* Active Status */}
              <div className="bg-gradient-to-r from-emerald-50 to-green-50 from-emerald-900/20 to-green-900/20 rounded-lg p-4 border border-emerald-200/50 border-emerald-700/50">
                <label className="flex items-center gap-3 cursor-pointer group">
                  ...
                  <div>
                    <span
                      className={`${T.label} font-semibold ${formData.isActive ? 'text-emerald-700 text-emerald-300' : ''}`}
                    >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className={`w-full p-3 ${T.input} rounded-lg border ${T.border} focus:ring-2 focus:ring-blue-500 focus:ring-blue-400 resize-none`}
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 border-gray-700">
            <button
              onClick={handleSave}
              className="w-full py-3 px-6 bg-blue-600 bg-blue-700 text-white rounded-lg hover:bg-blue-700 hover:bg-blue-600 font-semibold transition-colors shadow-lg"
            >
      ...
      {formData.isParticipant && hasStats && (
        <div className={`${T.cardBg} ${T.border} rounded-2xl p-6 shadow-lg`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {/* Total Matches */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 from-blue-900/20 to-blue-800/20 rounded-xl p-5 border border-blue-200 border-blue-700 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <span className="text-3xl">🎾</span>
                <div className="text-xs font-semibold text-blue-600 text-blue-400 uppercase">
                  Totali
                </div>
              </div>
            ...
            {/* Wins */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 from-green-900/20 to-green-800/20 rounded-xl p-5 border border-green-200 border-green-700 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <span className="text-3xl">✅</span>
                <div className="text-xs font-semibold text-green-600 text-green-400 uppercase">
                  Vinte
                </div>
              </div>
            ...
            {/* Losses */}
            <div className="bg-gradient-to-br from-red-50 to-red-100 from-red-900/20 to-red-800/20 rounded-xl p-5 border border-red-200 border-red-700 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <span className="text-3xl">❌</span>
                <div className="text-xs font-semibold text-red-600 text-red-400 uppercase">
                  Perse
                </div>
              </div>
            ...
            {/* Win Rate */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 from-purple-900/20 to-purple-800/20 rounded-xl p-5 border border-purple-200 border-purple-700 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <span className="text-3xl">🎯</span>
                <div className="text-xs font-semibold text-purple-600 text-purple-400 uppercase">
                  Ratio
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Initial Ranking */}
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 from-orange-900/20 to-orange-800/20 rounded-xl p-5 border-2 border-orange-200 border-orange-700">
              <div className="flex items-center gap-3 mb-3">
                <span className="text-3xl">🎯</span>
                <div className="text-xs font-bold text-orange-900 text-orange-200 uppercase tracking-wider">
                  Ranking Iniziale
                </div>
              </div>
              <div className="text-4xl font-black text-orange-600 text-orange-400">
                {stats.initialRanking || 'N/A'}
              </div>
              <div className="text-xs text-orange-700 text-orange-300 mt-2 font-medium">
                Punto di partenza
              </div>
            </div>

            {/* Current Ranking */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 from-purple-900/20 to-purple-800/20 rounded-xl p-5 border-2 border-purple-200 border-purple-700">
              <div className="flex items-center gap-3 mb-3">
                <span className="text-3xl">🏆</span>
                <div className="text-xs font-bold text-purple-900 text-purple-200 uppercase tracking-wider">
                  Ranking Attuale
                </div>
              </div>
              <div className="text-4xl font-black text-purple-600 text-purple-400">
                {stats.currentRanking || stats.initialRanking || 'N/A'}
              </div>
              <div className="text-xs text-purple-700 text-purple-300 mt-2 font-medium">
                Posizione corrente
              </div>
            </div>
            ...
            <div
              className={`rounded-xl p-5 border-2 ${
                rankingChange > 0
                  ? 'bg-gradient-to-br from-green-50 to-emerald-100 from-green-900/20 to-emerald-800/20 border-green-300 border-green-700'
                  : rankingChange < 0
                    ? 'bg-gradient-to-br from-red-50 to-pink-100 from-red-900/20 to-pink-800/20 border-red-300 border-red-700'
                    : 'bg-gradient-to-br from-gray-50 to-gray-100 from-gray-800/50 to-gray-900/50 border-gray-300 border-gray-700'
              }`}
            >
              <div className="flex items-center gap-3 mb-3">
          ...
          {stats.initialRanking && stats.currentRanking && (
            <div className="mt-6 p-4 bg-gray-50 bg-gray-800/50 rounded-xl">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-semibold text-gray-600 text-gray-400">
              ...
              <div className="h-4 bg-gray-200 bg-gray-700 rounded-full overflow-hidden">
                <div
          ...
          {/* Joined Date */}
          {stats.joinedAt && (
            <div className="mt-6 p-4 bg-blue-50 bg-blue-900/20 rounded-xl border border-blue-200 border-blue-700">
              <div className="flex items-center gap-3">
                <span className="text-2xl">📅</span>
                <div>
                  <div className="text-xs font-semibold text-blue-900 text-blue-200">
                    Membro dal
                  </div>
                  <div className="text-sm font-bold text-blue-700 text-blue-300">
      ...
      <div className={`${T.cardBg} ${T.border} rounded-2xl p-6 shadow-lg`}>
        ...
        {champEntries.length === 0 ? (
          <div className="text-sm italic text-gray-500 text-gray-400">Nessuna voce ancora</div>
        ) : (
          <ul className="space-y-2">
            {champEntries.map((e) => (
              <li
                key={e.id}
                className="flex items-center justify-between p-3 rounded-lg bg-gray-50 bg-gray-800/50 border border-gray-200 border-gray-700"
              >
                ...
                <div className="ml-4 shrink-0 text-right">
                  <div className="text-sm font-bold text-amber-600 text-amber-400">
                    +{Number(e.points || 0).toFixed(1)}
                  </div>
                  <div className="text-xs text-gray-500 text-gray-400">punti</div>
                </div>
              </li>
            ))}
          </ul>
      ...
      {/* Info Card */}
      <div className="bg-blue-50 bg-blue-900/20 rounded-lg p-4 border border-blue-200 border-blue-700">
