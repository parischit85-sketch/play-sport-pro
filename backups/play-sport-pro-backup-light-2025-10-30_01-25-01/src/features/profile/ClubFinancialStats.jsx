...
import { getClubStatistics, getTodayStats, getMonthlyStats } from '@services/clubStats.js';
  ...
  const loadFinancialData = async () => {
    try {
      ...
      const revenueByPaymentMethod = {
        ...
        Bonifico: Math.floor(totalRevenue * 0.1),
      };
    ...
    <Section title="💰 Statistiche Finanziarie" T={T}>
      <div className="bg-white/80 bg-gray-800/80 backdrop-blur-xl rounded-3xl border border-white/20 border-gray-700/20 p-6 shadow-2xl">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                timeRange === period.key
                  ...
                  : 'bg-white/60 bg-gray-700/60 text-gray-700 text-gray-300 hover:bg-green-100 hover:bg-green-900/30'
              }`}
            >
              {period.label}
            </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 from-green-900/30 to-emerald-900/30 rounded-2xl p-6 border border-green-200/30 border-green-700/30">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 text-white">Ricavi</h3>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 from-blue-900/30 to-indigo-900/30 rounded-2xl p-6 border border-blue-200/30 border-blue-700/30">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 text-white">Prenotazioni</h3>
              <span className="text-3xl">📅</span>
            </div>
            <div className="space-y-3">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 from-purple-900/30 to-pink-900/30 rounded-2xl p-6 border border-purple-200/30 border-purple-700/30">
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 from-amber-900/30 to-orange-900/30 rounded-2xl p-6 border border-amber-200/30 border-amber-700/30">
            <h3 className="text-lg font-semibold text-gray-900 text-white mb-4 flex items-center gap-2">
              <span className="text-2xl">🏆</span>
              Top Campi per Ricavi
            </h3>
        ...
        {/* Metriche Aggiuntive */}
        <div className="mt-6 pt-6 border-t border-white/20 border-gray-600/20">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 text-white">
                {(
                  (currentData.bookings / (courts?.length || 1)) *
