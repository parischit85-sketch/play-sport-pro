import { r as ke, g as $e, a as Fe } from './vendor-mfcrdn03-D3F3s8fL.js';
function Ne(e, t) {
...
var i = ke();
const De = $e(i),
  ar = Ne({ __proto__: null, default: De }, [i]);
/**
 * react-router v7.8.2
 *
...
function A({ pathname: e = '/', search: t = '', hash: r = '' }) {
  return (
...
function Te(e, t, r, n = {}) {
  ...
  function d() {
    ...
    let p = f(),
      m = p == null ? null : p - c;
    ((c = p), u && u({ action: s, location: w.location, delta: m }));
  }
  function y(p, m) {
    s = 'PUSH';
    let h = G(w.location, p, m);
    c = f() + 1;
    let R = se(h, c),
      C = w.createHref(h);
    try {
  ...
  function g(p, m) {
    ...
    let R = se(h, c),
      C = w.createHref(h);
    (l.replaceState(R, '', C), o && u && u({ action: s, location: w.location, delta: 0 }));
  }
  function v(p) {
    return Me(p);
  }
  let w = {
    ...
    listen(p) {
      ...
      return (
        a.addEventListener(ue, d),
        (u = p),
        () => {
          (a.removeEventListener(ue, d), (u = null));
        }
      );
    },
    createHref(p) {
...
function pe(e, t = [], r = [], n = '', a = !1) {
  let o = (l, s, u = a, c) => {
    ...
    (l.children &&
      ...
      pe(l.children, t, y, d, u)),
      !(l.path == null && !l.index) && t.push({ path: d, score: Ve(d, l.index), routesMeta: y }));
  };
  return (
    e.forEach((l, s) => {
      if (l.path === '' || !l.path?.includes('?')) o(l, s);
      else for (let u of me(l.path)) o(l, s, !0, u);
    }),
    t
  );
}
...
function Ve(e, t) {
  ...
  return (
    r.some(ce) && (n += ze),
    t && (n += He),
    r.filter((a) => !ce(a)).reduce((a, o) => a + (Ue.test(o) ? We : o === '' ? _e : je), n)
  );
}
function Je(e, t) {
...
function Ke(e, t, r = !1) {
  ...
  for (let s = 0; s < n.length; ++s) {
    let u = n[s],
      ...
      d = V({ path: u.relativePath, caseSensitive: u.caseSensitive, end: c }, f),
      y = u.route;
    if (
      (!d &&
        c &&
        ...
        (d = V({ path: u.relativePath, caseSensitive: u.caseSensitive, end: !1 }, f)),
      !d)
    )
      return null;
    (Object.assign(a, d.params),
      l.push({
        ...
        pathnameBase: Ze(k([o, d.pathnameBase])),
        route: y,
      }),
...
function V(e, t) {
  ...
  let [r, n] = Ye(e.path, e.caseSensitive, e.end),
    a = t.match(r);
  if (!a) return null;
  let o = a[0],
    l = o.replace(/(.)\/+$/, '$1'),
    s = a.slice(1);
  return {
    params: n.reduce((c, { paramName: f, isOptional: d }, y) => {
      if (f === '*') {
        let v = s[y] || '';
...
function Ge(e, t = '/') {
  let { pathname: r, search: n = '', hash: a = '' } = typeof e == 'string' ? D(e) : e;
  return { pathname: r ? (r.startsWith('/') ? r : Xe(r, t)) : t, search: et(n), hash: tt(a) };
}
function Xe(e, t) {
...
function ee(e, t, r, n = !1) {
  ...
  typeof e == 'string'
    ? (a = D(e))
    : ((a = { ...e }),
      x(!a.pathname || !a.pathname.includes('?'), Y('?', 'pathname', 'search', a)),
      x(!a.pathname || !a.pathname.includes('#'), Y('#', 'pathname', 'hash', a)),
      x(!a.search || !a.search.includes('#'), Y('#', 'search', 'hash', a)));
  let o = e === '' || a.pathname === '',
    l = o ? '/' : a.pathname,
    s;
  if (l == null) s = r;
...
var L = i.createContext({ outlet: null, matches: [], isDataRoute: !1 });
L.displayName = 'Route';
var te = i.createContext(null);
te.displayName = 'RouteError';
function lt(e, { relative: t } = {}) {
  x(O(), 'useHref() may be used only in the context of a <Router> component.');
  let { basename: r, navigator: n } = i.useContext(S),
    { hash: a, pathname: o, search: l } = U(e, { relative: t }),
    s = o;
  return (
    r !== '/' && (s = o === '/' ? r : k([r, o])),
...
function O() {
  return i.useContext(B) != null;
}
function F() {
  return (
    x(O(), 'useLocation() may be used only in the context of a <Router> component.'),
    i.useContext(B).location
  );
}
var ve =
...
function it() {
  x(O(), 'useNavigate() may be used only in the context of a <Router> component.');
  let e = i.useContext(I),
    { basename: t, navigator: r } = i.useContext(S),
    { matches: n } = i.useContext(L),
    { pathname: a } = F(),
  ...
  return (
    ...
    i.useCallback(
      (u, c = {}) => {
        if ((E(l.current, ve), !l.current)) return;
        if (typeof u == 'number') {
          r.go(u);
          return;
        }
        let f = ee(u, JSON.parse(o), a, c.relative === 'path');
        (e == null && t !== '/' && (f.pathname = f.pathname === '/' ? t : k([t, f.pathname])),
...
function st(e) {
  let t = i.useContext(L).outlet;
  return t && i.createElement(ut.Provider, { value: e }, t);
}
function U(e, { relative: t } = {}) {
  let { matches: r } = i.useContext(L),
    { pathname: n } = F(),
    a = JSON.stringify(Z(r));
  return i.useMemo(() => ee(e, JSON.parse(a), n, t === 'path'), [e, a, n, t]);
}
function ct(e, t) {
  return Re(e, t);
}
function Re(e, t, r, n, a) {
  x(O(), 'useRoutes() may be used only in the context of a <Router> component.');
  let { navigator: o } = i.useContext(S),
    { matches: l } = i.useContext(L),
    s = l[l.length - 1],
    u = s ? s.params : {},
    c = s ? s.pathname : '/',
    f = s ? s.pathnameBase : '/',
...
Please change the parent <Route path="${h}"> to <Route path="${h === '/' ? '*' : `${h}/*`}">.`
  ...
  let y = F(),
    g;
  if (t) {
    let h = typeof t == 'string' ? D(t) : t;
    (x(
      f === '/' || h.pathname?.startsWith(f),
      `When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${f}" but pathname "${h.pathname}" was given in the \`location\` prop.`
    ),
      (g = h));
  } else g = y;
  let v = g.pathname || '/',
  ...
  let p = he(e, { pathname: w });
  (E(d || p != null, `No routes matched location "${g.pathname}${g.search}${g.hash}" `),
    E(
      p == null ||
    ...
    p &&
      p.map((h) =>
        Object.assign({}, h, {
          ...
          pathname: k([f, o.encodeLocation ? o.encodeLocation(h.pathname).pathname : h.pathname]),
          pathnameBase:
            h.pathnameBase === '/'
              ? f
              : k([
...
function ft() {
  ...
  return (
    ...
    i.createElement(
      ...
      r ? i.createElement('pre', { style: a }, r) : null,
      l
    )
  );
}
var dt = i.createElement(ft, null),
  ht = class extends i.Component {
    constructor(e) {
      (super(e),
...
function pt({ routeContext: e, match: t, children: r }) {
  let n = i.useContext(I);
  return (
    n &&
      n.static &&
      n.staticContext &&
    ...
    i.createElement(L.Provider, { value: e }, r)
  );
}
function mt(e, t = [], r = null, n = null, a = null) {
  if (e == null) {
    if (!r) return null;
  ...
  let o = e,
    l = r?.errors;
  if (l != null) {
    let c = o.findIndex((f) => f.route.id && l?.[f.route.id] !== void 0);
    (x(
      c >= 0,
    ...
    for (let c = 0; c < o.length; c++) {
      ...
      if (((f.route.HydrateFallback || f.route.hydrateFallbackElement) && (u = c), f.route.id)) {
        let { loaderData: d, errors: y } = r,
          g = f.route.loader && !d.hasOwnProperty(f.route.id) && (!y || y[f.route.id] === void 0);
        if (f.route.lazy || g) {
      ...
      s &&
        (u < 0 && d === 0
          ? (xe(
            ...
            (g = !0),
            (w = null))
          : u === d && ((g = !0), (w = f.route.hydrateFallbackElement || null))));
...
function ae(e) {
  ...
  return (x(r.route.id, `${e} can only be used on routes that contain a unique "id"`), r.route.id);
}
function wt() {
  return ae('useRouteId');
}
function Rt() {
...
i.memo(Et);
function Et({ routes: e, future: t, state: r, unstable_onError: n }) {
  return Re(e, void 0, r, n, t);
}
function or({ to: e, replace: t, state: r, relative: n }) {
  x(O(), '<Navigate> may be used only in the context of a <Router> component.');
  let { static: a } = i.useContext(S);
  E(
    !a,
    '<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.'
  );
  let { matches: o } = i.useContext(L),
    { pathname: l } = F(),
    s = re(),
    u = ee(e, Z(o), l, n === 'path'),
    c = JSON.stringify(u);
...
function bt({
  ...
  let l = e.replace(/^\/*/, '/'),
    s = i.useMemo(() => ({ basename: l, navigator: a, static: o, future: {} }), [l, a, o]);
  ...
  let { pathname: u = '/', search: c = '', hash: f = '', state: d = null, key: y = 'default' } = r,
    g = i.useMemo(() => {
      ...
      return v == null
        ? null
        : { location: { pathname: v, search: c, hash: f, state: d, key: y }, navigationType: n };
    }, [l, u, c, f, d, y, n]);
  return (
    E(
      g != null,
    ...
    g == null
      ...
      : i.createElement(
          S.Provider,
          { value: s },
          i.createElement(B.Provider, { children: t, value: g })
        )
  );
}
function ir({ children: e, location: t }) {
  return ct(X(e), t);
}
function X(e, t = []) {
  let r = [];
  return (
    i.Children.forEach(e, (n, a) => {
      if (!i.isValidElement(n)) return;
      let o = [...t, a];
      if (n.type === i.Fragment) {
        r.push.apply(r, X(n.props.children, o));
        return;
      }
      (x(
        n.type === Ct,
        ...
        x(!n.props.index || !n.props.children, 'An index route cannot have child routes.'));
      let l = {
      ...
      (n.props.children && (l.children = X(n.props.children, o)), r.push(l));
    }),
    r
  );
}
...
function Nt() {
  if (_ === null)
    try {
      (new FormData(document.createElement('form'), 0), (_ = !1));
    } catch {
      _ = !0;
    }
  return _;
}
var Dt = new Set(['application/x-www-form-urlencoded', 'multipart/form-data', 'text/plain']);
function q(e) {
  return e != null && !Dt.has(e)
    ? (E(
        !1,
...
function It(e, t) {
  ...
  if (St(e)) {
    ...
    ((n = s ? $(s, t) : null),
      ...
      (a = q(e.getAttribute('enctype')) || z),
      (o = new FormData(e)));
  } else if (Pt(e) || (Lt(e) && (e.type === 'submit' || e.type === 'image'))) {
    let s = e.form;
    if (s == null)
    ...
    if (
      ...
      (a = q(e.getAttribute('formenctype')) || q(s.getAttribute('enctype')) || z),
      (o = new FormData(s, e)),
      !Nt())
    ) {
...
function de(e, t, r, n, a, o) {
  let l = (u, c) => (r[c] ? u.route.id !== r[c].route.id : !0),
    s = (u, c) =>
      r[c].pathname !== u.pathname ||
      (r[c].route.path?.endsWith('*') && r[c].params['*'] !== u.params['*']);
  return o === 'assets'
    ? t.filter((u, c) => l(u, c) || s(u, c))
    : o === 'data'
      ? t.filter((u, c) => {
          let f = n.routes[u.route.id];
          if (!f || !f.hasLoader) return !1;
          if (l(u, c) || s(u, c)) return !0;
...
function _t() {
  ...
  return (
    oe(e, 'You must render this element inside a <DataRouterStateContext.Provider> element'),
    e
  );
}
...
function jt(e, t) {
  let r = i.useContext(le),
    [n, a] = i.useState(!1),
    [o, l] = i.useState(!1),
    { onFocus: s, onBlur: u, onMouseEnter: c, onMouseLeave: f, onTouchStart: d } = t,
    y = i.useRef(null);
  (i.useEffect(() => {
    if ((e === 'render' && l(!0), e === 'viewport')) {
      let w = (m) => {
        ...
        p = new IntersectionObserver(w, { threshold: 0.5 });
      return (
        y.current && p.observe(y.current),
        () => {
          p.disconnect();
        }
      );
...
function zt({ page: e, ...t }) {
  let { router: r } = Ee(),
    n = i.useMemo(() => he(r.routes, e, r.basename), [r.routes, e, r.basename]);
  return n ? i.createElement(Jt, { page: e, matches: n, ...t }) : null;
}
function Vt(e) {
  let { manifest: t, routeModules: r } = Ce(),
    [n, a] = i.useState([]);
  return (
    i.useEffect(() => {
      let o = !1;
...
function Jt({ page: e, matches: t, ...r }) {
  let n = F(),
    { manifest: a, routeModules: o } = Ce(),
    { basename: l } = Ee(),
    { loaderData: s, matches: u } = _t(),
    c = i.useMemo(() => de(e, t, u, a, n, 'data'), [e, t, u, a, n]),
    f = i.useMemo(() => de(e, t, u, a, n, 'assets'), [e, t, u, a, n]),
    d = i.useMemo(() => {
      ...
      if (
        (t.forEach((m) => {
          let h = a.routes[m.route.id];
          !h ||
            !h.hasLoader ||
            ((!c.some((R) => R.route.id === m.route.id) &&
              m.route.id in s &&
              o[m.route.id]?.shouldRevalidate) ||
            h.hasClientLoader
              ? (w = !0)
              : v.add(m.route.id));
        }),
    ...
    y = i.useMemo(() => Bt(f, a), [f, a]),
    g = Vt(f);
  return i.createElement(
    i.Fragment,
    null,
    d.map((v) => i.createElement('link', { key: v, rel: 'prefetch', as: 'fetch', href: v, ...r })),
    y.map((v) => i.createElement('link', { key: v, rel: 'modulepreload', href: v, ...r })),
    g.map(({ key: v, link: w }) => i.createElement('link', { key: v, nonce: r.nonce, ...w }))
  );
}
function Kt(...e) {
  return (t) => {
...
try {
  be && (window.__reactRouterVersion = '7.8.2');
} catch {}
function ur({ basename: e, children: t, window: r }) {
  let n = i.useRef();
  n.current == null && (n.current = Ie({ window: r, v5Compat: !0 }));
  let a = n.current,
    [o, l] = i.useState({ action: a.action, location: a.location }),
    s = i.useCallback(
      (u) => {
  ...
  return (
    i.useLayoutEffect(() => a.listen(s), [a, s]),
    i.createElement(bt, {
      basename: e,
      children: t,
      location: o.location,
...
var Pe = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Se = i.forwardRef(function (
    ...
    let { basename: v } = i.useContext(S),
      w = typeof c == 'string' && Pe.test(c),
      p,
      m = !1;
    if (typeof c == 'string' && w && ((p = c), be))
      try {
        let P = new URL(window.location.href),
          N = c.startsWith('//') ? new URL(P.protocol + c) : new URL(c),
          ie = $(N.pathname, v);
        N.origin === P.origin && ie != null ? (c = ie + N.search + N.hash) : (m = !0);
      } catch {
        E(
          !1,
    ...
    function T(P) {
      (t && t(P), P.defaultPrevented || W(P));
    }
    let H = i.createElement('a', {
      ...y,
      ...b,
      href: p || h,
      onClick: m || o ? t : T,
    ...
    return R && !w ? i.createElement(i.Fragment, null, H, i.createElement(zt, { page: h })) : H;
  });
Se.displayName = 'Link';
var Yt = i.forwardRef(function (
  {
    'aria-current': t = 'page',
    caseSensitive: r = !1,
    className: n = '',
  ...
  let d = U(l, { relative: c.relative }),
    y = F(),
    g = i.useContext(J),
    { navigator: v, basename: w } = i.useContext(S),
    p = g != null && rr(d) && s === !0,
    m = v.encodeLocation ? v.encodeLocation(d).pathname : d.pathname,
    h = y.pathname,
    R = g && g.navigation && g.navigation.location ? g.navigation.location.pathname : null;
  (r || ((h = h.toLowerCase()), (R = R ? R.toLowerCase() : null), (m = m.toLowerCase())),
    R && w && (R = $(R, w) || R));
  const C = m !== '/' && m.endsWith('/') ? m.length - 1 : m.length;
  let b = h === m || (!a && h.startsWith(m) && h.charAt(C) === '/'),
    W = R != null && (R === m || (!a && R.startsWith(m) && R.charAt(m.length) === '/')),
    T = { isActive: b, isPending: W, isTransitioning: p },
    H = b ? t : void 0,
    P;
  typeof n == 'function'
    ? (P = n(T))
    : (P = [n, b ? 'active' : null, W ? 'pending' : null, p ? 'transitioning' : null]
        .filter(Boolean)
        .join(' '));
  let N = typeof o == 'function' ? o(T) : o;
  return i.createElement(
    Se,
    { ...c, 'aria-current': H, className: P, ref: f, style: N, to: l, viewTransition: s },
...
var qt = i.forwardRef(
  (
    ...
    let v = er(),
      ...
      m = typeof s == 'string' && Pe.test(s),
      h = (R) => {
        if ((u && u(R), R.defaultPrevented)) return;
        R.preventDefault();
        let C = R.nativeEvent.submitter,
          b = C?.getAttribute('formmethod') || l;
        v(C || R.currentTarget, {
          fetcherKey: t,
          method: b,
          navigate: r,
  ...
  return i.useCallback(
    (f) => {
      if ($t(f, t)) {
        ...
        s(e, { replace: d, state: n, preventScrollReset: a, relative: o, viewTransition: l });
      }
    },
    [u, s, c, r, n, t, e, a, o, l]
  );
...
function sr(e) {
  ...
  let t = i.useRef(Q(e)),
    r = i.useRef(!1),
    n = F(),
    a = i.useMemo(() => Ft(n.search, r.current ? null : t.current), [n.search]),
    o = re(),
    l = i.useCallback(
      (s, u) => {
        const c = Q(typeof s == 'function' ? s(new URLSearchParams(a)) : s);
        ((r.current = !0), o('?' + c, u));
      },
      [o, a]
    );
...
function er() {
  ...
  return i.useCallback(
    async (n, a = {}) => {
      let { action: o, method: l, encType: s, formData: u, body: c } = It(n, t);
      if (a.navigate === !1) {
        let f = a.fetcherKey || Zt();
...
function tr(e, { relative: t } = {}) {
  ...
  return (
    ...
    r !== '/' && (o.pathname = o.pathname === '/' ? r : k([r, o.pathname])),
    A(o)
  );
}
function rr(e, { relative: t } = {}) {
  let r = i.useContext(ge);
  x(
    r != null,
    "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?"
  );
  let { basename: n } = Le('useViewTransitionState'),
    a = U(e, { relative: t });
  if (!r.isTransitioning) return !1;
  let o = $(r.currentLocation.pathname, n) || r.currentLocation.pathname,
    l = $(r.nextLocation.pathname, n) || r.nextLocation.pathname;
