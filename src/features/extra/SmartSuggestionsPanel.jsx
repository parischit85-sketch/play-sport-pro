...
// ============================================
export function SmartSuggestionsPanel({ isOpen, onClose, courts = [], bookings = [], onApplySuggestion, T }) {
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          {selectedSuggestion?.id === suggestion.id && (
                            <div className="mt-3 p-3 bg-white/50 dark:bg-gray-900/50 rounded-lg text-xs">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                        >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-xl p-4">
                  ...
                  <div className="text-sm text-blue-700 dark:text-blue-400">Prenotazioni Totali</div>
                </div>
                <div className="bg-green-50 dark:bg-green-900/20 border-2 border-green-200 dark:border-green-800 rounded-xl p-4">
                  ...
                  <div className="text-sm text-green-700 dark:text-green-400">Revenue Totale</div>
                </div>
                <div className="bg-purple-50 dark:bg-purple-900/20 border-2 border-purple-200 dark:border-purple-800 rounded-xl p-4">
                  ...
                  <div className="text-sm text-purple-700 dark:text-purple-400">Prezzo Medio</div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-4">
                ...
                <div className="space-y-2">
                  {['Domenica', 'Lunedì', 'Martedì', 'Mercoledì', 'Giovedì', 'Venerdì', 'Sabato'].map(
                    (day, index) => {
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
                ...
                <p className="text-sm text-blue-800 dark:text-blue-400">
                  Visualizza il tasso di occupazione per ogni fascia oraria. Verde = alta occupazione,
                  Rosso = bassa occupazione.
                </p>
              </div>
              ...
              <div className="space-y-2">
                {heatmap.map((slot, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-32 font-medium text-gray-900 dark:text-white">
                        {slot.timeRange}
                      </div>
