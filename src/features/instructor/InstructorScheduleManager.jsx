...
export default function InstructorScheduleManager({ compact = false }) {
  ...
  const instructorSlots = useMemo(() => {
    ...
    return timeSlots.filter(slot =>
      slot.instructorIds?.includes(user.uid) ||
      slot.instructorId === user.uid
    );
  }, [timeSlots, user?.uid]);
      ...
      <div className="space-y-4">
        {slotsForSelectedDate.length === 0 ? (
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
            ...
            <p className="text-sm">
              Aggiungi le tue fasce orarie per questo giorno
            </p>
          </div>
        ) : (
        ...
        <form onSubmit={handleSubmitSlot} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setSlotForm(prev => ({ ...prev, maxParticipants: parseInt(e.target.value) || 1 }))}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setSlotForm(prev => ({ ...prev, price: parseFloat(e.target.value) || 0 }))}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
