const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/LoginPage-mfd5b0nk-BlOPe0V2.js',
      'assets/router-mfd5b0nk-DvckVtmx.js',
      'assets/vendor-mfd5b0nk-D3F3s8fL.js',
      'assets/Section-mfd5b0nk-D35NiLFM.js',
      'assets/firebase-mfd5b0nk-BteSMG94.js',
      'assets/DashboardPage-mfd5b0nk-DINpbLcQ.js',
      'assets/ClassificaPage-mfd5b0nk-HEq6V4g6.js',
      'assets/charts-mfd5b0nk-DguzL_lN.js',
      'assets/ShareButtons-mfd5b0nk-CXSgbsdZ.js',
      'assets/StatsPage-mfd5b0nk-CUl0A0BI.js',
      'assets/Modal-mfd5b0nk-DpDbGk5Z.js',
      'assets/names-mfd5b0nk-BW9lV2zG.js',
      'assets/BookingPage-mfd5b0nk-BmvpsHSO.js',
      'assets/bookings-mfd5b0nk-BT0YhiEc.js',
      'assets/cloud-bookings-mfd5b0nk-CjscFiW7.js',
      'assets/pricing-mfd5b0nk-DMaWA4wL.js',
      'assets/PlayersPage-mfd5b0nk-aeXxXbey.js',
      'assets/MatchesPage-mfd5b0nk-BuM_gK4-.js',
      'assets/TournamentsPage-mfd5b0nk-D4fJb8XF.js',
      'assets/ProfilePage-mfd5b0nk-BE12vBc0.js',
      'assets/Extra-mfd5b0nk-DEweuh_K.js',
      'assets/format-mfd5b0nk-DAEZv7Mi.js',
      'assets/ExtraPage-mfd5b0nk-C58kxsLD.js',
      'assets/AdminBookingsPage-mfd5b0nk-CQiGB4U-.js',
    ])
) => i.map((i) => d[i]);
import { r as Te, a as ze } from './vendor-mfd5b0nk-D3F3s8fL.js';
import {
  r as x,
  b as P,
  u as Q,
  ...
  d as Fe,
  e as _,
} from './router-mfd5b0nk-DvckVtmx.js';
import {
  g as me,
  a as fe,
  i as ge,
  ...
  v as tt,
  w as st,
} from './firebase-mfd5b0nk-BteSMG94.js';
(function () {
...
const Ut = P.lazy(() =>
    B(() => import('./LoginPage-mfd5b0nk-BlOPe0V2.js'), __vite__mapDeps([0, 1, 2, 3, 4]))
  ),
  Vt = P.lazy(() =>
    B(() => import('./DashboardPage-mfd5b0nk-DINpbLcQ.js'), __vite__mapDeps([5, 1, 2, 4]))
  ),
  Ht = P.lazy(() =>
    B(() => import('./ClassificaPage-mfd5b0nk-HEq6V4g6.js'), __vite__mapDeps([6, 1, 2, 3, 7, 8, 4]))
  ),
  qt = P.lazy(() =>
    B(
      () => import('./StatsPage-mfd5b0nk-CUl0A0BI.js'),
      __vite__mapDeps([9, 1, 2, 3, 8, 7, 10, 11, 4])
    )
  ),
  Gt = P.lazy(() =>
    B(
      () => import('./BookingPage-mfd5b0nk-BmvpsHSO.js'),
      __vite__mapDeps([12, 1, 2, 13, 14, 4, 15])
    )
  ),
  Jt = P.lazy(() =>
    B(
      () => import('./PlayersPage-mfd5b0nk-aeXxXbey.js'),
      __vite__mapDeps([16, 1, 2, 3, 10, 11, 14, 4])
    )
  ),
  Kt = P.lazy(() =>
    B(() => import('./MatchesPage-mfd5b0nk-BuM_gK4-.js'), __vite__mapDeps([17, 1, 2, 3, 11, 4]))
  ),
  Yt = P.lazy(() =>
    B(() => import('./TournamentsPage-mfd5b0nk-D4fJb8XF.js'), __vite__mapDeps([18, 1, 2, 3, 4]))
  ),
  Xt = P.lazy(() =>
    B(
      () => import('./ProfilePage-mfd5b0nk-BE12vBc0.js'),
      __vite__mapDeps([19, 1, 2, 3, 10, 20, 21, 14, 4])
    )
  ),
  Zt = P.lazy(() =>
    B(() => import('./ExtraPage-mfd5b0nk-C58kxsLD.js'), __vite__mapDeps([22, 1, 2, 20, 3, 21, 4]))
  ),
  Qt = P.lazy(() =>
    B(
      () => import('./AdminBookingsPage-mfd5b0nk-CQiGB4U-.js'),
