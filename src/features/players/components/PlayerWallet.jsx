...
export default function PlayerWallet({ player, onUpdate, T }) {
  ...
  const wallet = player.wallet || { balance: 0, currency: 'EUR', transactions: [] };
    ...
    <div className="space-y-6">
      ...
      <div className={`${T.cardBg} ${T.border} rounded-xl p-6 text-center`}>
        ...
        <div className="flex justify-center gap-3">
          <button
            onClick={() => {
              setTransactionData({ ...createTransactionSchema(), type: 'credit' });
          ...
          <button
            onClick={() => {
              setTransactionData({ ...createTransactionSchema(), type: 'debit' });
              setShowAddTransaction(true);
            }}
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setTransactionData((prev) => ({ ...prev, type: e.target.value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTransactionData((prev) => ({ ...prev, amount: Number(e.target.value) }))
                  }
                  className={`${T.input} w-full`}
                  min="0"
                  step="0.01"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setTransactionData((prev) => ({ ...prev, reference: e.target.value }))
                }
                className={`${T.input} w-full`}
