const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/LoginPage-mfbc5cuw-B7fDcGEd.js',
      'assets/router-mfbc5cuw-tw9hraEf.js',
      'assets/vendor-mfbc5cuw-D3F3s8fL.js',
      'assets/Section-mfbc5cuw-CH6um2i6.js',
      'assets/firebase-mfbc5cuw-jcIpuiEY.js',
      'assets/DashboardPage-mfbc5cuw-D5Si9Unh.js',
      'assets/ClassificaPage-mfbc5cuw-ClLOkmtS.js',
      'assets/charts-mfbc5cuw-Dk1HU810.js',
      'assets/ShareButtons-mfbc5cuw-D_34qEjG.js',
      'assets/StatsPage-mfbc5cuw-woN2BmnH.js',
      'assets/Modal-mfbc5cuw-w_SuV9jq.js',
      'assets/names-mfbc5cuw-BW9lV2zG.js',
      'assets/BookingPage-mfbc5cuw-C8uNNESj.js',
      'assets/bookings-mfbc5cuw-C8BbWzZc.js',
      'assets/cloud-bookings-mfbc5cuw-D5b_T57O.js',
      'assets/pricing-mfbc5cuw-CpqSxGe3.js',
      'assets/PlayersPage-mfbc5cuw-7L4WVsQU.js',
      'assets/MatchesPage-mfbc5cuw-C1Z-nPIH.js',
      'assets/TournamentsPage-mfbc5cuw-BwxGeIv0.js',
      'assets/ProfilePage-mfbc5cuw-o7thmHw1.js',
      'assets/Extra-mfbc5cuw-CZXxdoCy.js',
      'assets/format-mfbc5cuw-DAEZv7Mi.js',
      'assets/ExtraPage-mfbc5cuw-BQtQnr45.js',
      'assets/AdminBookingsPage-mfbc5cuw-C3VtDRMw.js',
    ])
) => i.map((i) => d[i]);
import { r as Re, a as De } from './vendor-mfbc5cuw-D3F3s8fL.js';
import {
  r as x,
  b as C,
  u as Q,
  ...
  d as We,
  e as _,
} from './router-mfbc5cuw-tw9hraEf.js';
import {
  g as ue,
  a as me,
  i as fe,
  ...
  r as Qe,
  t as et,
} from './firebase-mfbc5cuw-jcIpuiEY.js';
(function () {
...
const Wt = C.lazy(() =>
    B(() => import('./LoginPage-mfbc5cuw-B7fDcGEd.js'), __vite__mapDeps([0, 1, 2, 3, 4]))
  ),
  $t = C.lazy(() =>
    B(() => import('./DashboardPage-mfbc5cuw-D5Si9Unh.js'), __vite__mapDeps([5, 1, 2, 4]))
  ),
  Ft = C.lazy(() =>
    B(() => import('./ClassificaPage-mfbc5cuw-ClLOkmtS.js'), __vite__mapDeps([6, 1, 2, 3, 7, 8, 4]))
  ),
  Ut = C.lazy(() =>
    B(
      () => import('./StatsPage-mfbc5cuw-woN2BmnH.js'),
      __vite__mapDeps([9, 1, 2, 3, 8, 7, 10, 11, 4])
    )
  ),
  Vt = C.lazy(() =>
    B(
      () => import('./BookingPage-mfbc5cuw-C8uNNESj.js'),
      __vite__mapDeps([12, 1, 2, 13, 14, 4, 15])
    )
  ),
  Ht = C.lazy(() =>
    B(() => import('./PlayersPage-mfbc5cuw-7L4WVsQU.js'), __vite__mapDeps([16, 1, 2, 3, 11, 4]))
  ),
  qt = C.lazy(() =>
    B(() => import('./MatchesPage-mfbc5cuw-C1Z-nPIH.js'), __vite__mapDeps([17, 1, 2, 3, 11, 4]))
  ),
  Gt = C.lazy(() =>
    B(() => import('./TournamentsPage-mfbc5cuw-BwxGeIv0.js'), __vite__mapDeps([18, 1, 2, 3, 4]))
  ),
  Jt = C.lazy(() =>
    B(
      () => import('./ProfilePage-mfbc5cuw-o7thmHw1.js'),
      __vite__mapDeps([19, 1, 2, 3, 10, 20, 21, 14, 4])
    )
  ),
  Kt = C.lazy(() =>
    B(() => import('./ExtraPage-mfbc5cuw-BQtQnr45.js'), __vite__mapDeps([22, 1, 2, 20, 3, 21, 4]))
  ),
  Yt = C.lazy(() =>
    B(
      () => import('./AdminBookingsPage-mfbc5cuw-C3VtDRMw.js'),
