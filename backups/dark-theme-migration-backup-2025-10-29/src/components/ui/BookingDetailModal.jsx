  ...
  return (
    <Modal open={isOpen} onClose={onClose} title="Dettaglio Prenotazione" T={T} size="md">
      <div className="space-y-6">
        ...
        {/* Header compatto */}
        <div
          className={`bg-gradient-to-br ${isLessonBooking ? 'from-green-500/90 to-green-600/90' : 'from-blue-500/90 to-blue-600/90'} backdrop-blur-xl rounded-2xl p-6 text-white shadow-lg ${isLessonBooking ? 'shadow-green-100/30 dark:shadow-green-900/20' : 'shadow-blue-100/30 dark:shadow-blue-900/20'}`}
        >
