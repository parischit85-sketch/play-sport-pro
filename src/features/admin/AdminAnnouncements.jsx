        ...
        <div
          className={`mb-6 p-4 rounded-lg ${
            lastResult.success
              ...
              : 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700/30 text-red-800 dark:text-red-200'
          }`}
        >
      ...
      <div className="space-y-4">
        ...
        {(title || message) && (
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700/30 rounded-lg p-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-md max-w-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-400 dark:text-gray-600 text-xs mt-2">Adesso</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700/30 rounded-lg p-3">
          <p className="text-xs text-yellow-800 dark:text-yellow-200">
            ⚠️ <strong>Attenzione:</strong> Le notifiche verranno inviate in batch di 10 utenti
            alla volta. L'operazione potrebbe richiedere alcuni secondi per completarsi.
          </p>
        </div>
      </div>
    </div>
