      ...
      {days.map((d, i) => (
        <button
          ...
          className={`px-2 h-6 rounded-md text-xs ring-1 ${
            value.includes(i)
              ? 'bg-emerald-500 text-black text-white ring-emerald-500/60'
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-3">
              ...
              <div className="flex lg:justify-end">
                <div
                  className="flex-shrink-0 px-3 py-2 rounded-lg ring-1 bg-emerald-50/50 bg-emerald-900/20"
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-xl sm:text-2xl font-extrabold leading-none text-emerald-800 text-emerald-200">
