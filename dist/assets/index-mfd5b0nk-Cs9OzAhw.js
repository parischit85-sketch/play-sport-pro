...
function v(t = {}) {
  return (
    ...
    (t.includeStyleProperties
      ? ((g = t.includeStyleProperties), g)
      : ((g = m(window.getComputedStyle(document.documentElement))), g))
  );
}
function y(t, e) {
...
function z(t) {
  const e = y(t, 'border-left-width'),
    n = y(t, 'border-right-width');
  return t.clientWidth + e + n;
}
function G(t) {
  const e = y(t, 'border-top-width'),
...
function J(t) {
  (t.width > u || t.height > u) &&
    (t.width > u && t.height > u
      ? t.width > t.height
        ? ((t.height *= u / t.width), (t.width = u))
        : ((t.width *= u / t.height), (t.height = u))
      : t.width > u
        ? ((t.height *= u / t.width), (t.width = u))
        : ((t.width *= u / t.height), (t.height = u)));
}
  ...
  return t.toBlob
    ...
    : new Promise((n) => {
        const r = window.atob(
          ...
          s = r.length,
          i = new Uint8Array(s);
        for (let a = 0; a < s; a += 1) i[a] = r.charCodeAt(a);
...
async function P(t, e, n) {
  ...
  try {
    const i = await U(
      t,
      n.fetchRequestInit,
      ({ res: a, result: c }) => (e || (e = a.headers.get('Content-Type') || ''), it(c))
    );
    s = st(i, e);
  } catch (i) {
...
const ft = (t) => t.tagName != null && t.tagName.toUpperCase() === 'SLOT',
  k = (t) => t.tagName != null && t.tagName.toUpperCase() === 'SVG';
async function ht(t, e, n) {
  var r, s;
  if (k(e)) return e;
  let i = [];
  return (
    ft(t) && t.assignedNodes
      ? (i = m(t.assignedNodes()))
      : l(t, HTMLIFrameElement) && !((r = t.contentDocument) === null || r === void 0) && r.body
        ? (i = m(t.contentDocument.body.childNodes))
        : (i = m(((s = t.shadowRoot) !== null && s !== void 0 ? s : t).childNodes)),
    i.length === 0 ||
      l(t, HTMLVideoElement) ||
      (await i.reduce(
        (a, c) =>
...
function mt(t, e, n) {
  ...
  s.cssText
    ? ((r.cssText = s.cssText), (r.transformOrigin = s.transformOrigin))
    : v(n).forEach((i) => {
        let a = s.getPropertyValue(i);
        (i === 'font-size' &&
          a.endsWith('px') &&
          (a = `${Math.floor(parseFloat(a.substring(0, a.length - 2))) - 0.1}px`),
          l(t, HTMLIFrameElement) && i === 'display' && a === 'inline' && (a = 'block'),
          i === 'd' && e.getAttribute('d') && (a = `path(${e.getAttribute('d')})`),
          r.setProperty(i, a, s.getPropertyPriority(i)));
      });
}
function gt(t, e) {
  (l(t, HTMLTextAreaElement) && (e.innerHTML = t.value),
    l(t, HTMLInputElement) && e.setAttribute('value', t.value));
}
function dt(t, e) {
  if (l(t, HTMLSelectElement)) {
    const n = e,
      r = Array.from(n.children).find((s) => t.value === s.getAttribute('value'));
...
async function wt(t, e) {
  ...
  if (s.length) {
    ...
    a.appendChild(c);
    for (let o = 0; o < s.length; o++) c.appendChild(s[o]);
    t.appendChild(a);
  }
  return t;
}
...
async function xt(t, e, n, r, s) {
  try {
    const i = n ? B(e, n) : e,
      a = C(e);
    let c;
    return (s || (c = await P(i, a, r)), t.replace(St(e), `$1${c}$3`));
  } catch {}
  return t;
}
...
async function Ct(t, e) {
  ((await d('background', t, e)) || (await d('background-image', t, e)),
    (await d('mask', t, e)) ||
      (await d('-webkit-mask', t, e)) ||
      (await d('mask-image', t, e)) ||
      (await d('-webkit-mask-image', t, e)));
}
async function Pt(t, e) {
  const n = l(t, HTMLImageElement);
  if (!(n && !x(t.src)) && !(l(t, SVGImageElement) && !x(t.href.baseVal))) return;
  ...
  await new Promise((i, a) => {
    ...
    (c.decode && (c.decode = i),
      ...
      n ? ((t.srcset = ''), (t.src = s)) : (t.href.baseVal = s));
  });
}
...
async function A(t, e) {
  let n = t.cssText;
  const r = /url\(["']?([^"')]+)["']?\)/g,
    i = (n.match(/url\([^)]+\)/g) || []).map(async (a) => {
      let c = a.replace(r, '$1');
      return (
        c.startsWith('https://') || (c = new URL(c, t.url).href),
        U(c, e.fetchRequestInit, ({ result: o }) => ((n = n.replace(a, `url(${o})`)), [a, o]))
      );
    });
...
function D(t) {
  ...
  for (;;) {
    let o = i.exec(r);
    if (o === null) {
      if (((o = c.exec(r)), o === null)) break;
      i.lastIndex = c.lastIndex;
    } else c.lastIndex = i.lastIndex;
    e.push(o[0]);
  }
  return e;
}
              ...
              const o = i.href,
                f = I(o)
                  ...
                  .then((h) =>
                    D(h).forEach((S) => {
                      try {
                        s.insertRule(S, S.startsWith('@import') ? (c += 1) : s.cssRules.length);
                      } catch (W) {
...
async function q(t, e) {
  ...
  return (
    await Promise.all(
      n
        .filter((i) => r.has(_(i.style.fontFamily)))
        .map((i) => {
...
async function Ut(t, e = {}) {
  const { width: n, height: r } = R(t, e);
  return (await b(t, e)).getContext('2d').getImageData(0, 0, n, r).data;
}
async function kt(t, e = {}) {
  return (await b(t, e)).toDataURL();
}
async function Ht(t, e = {}) {
  return (await b(t, e)).toDataURL('image/jpeg', e.quality || 1);
}
async function Vt(t, e = {}) {
  const n = await b(t, e);
  return await K(n);
