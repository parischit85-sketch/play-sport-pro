    ...
    <div className="space-y-6">
        ...
        {user ? (
          ...
          <div className={`${T.cardBg} ${T.border} ${T.borderMd} p-4 mb-6 text-center`}>
            ...
            <p className="text-xs text-gray-500">
              Le prenotazioni possono essere cancellate fino a 24 ore prima dell'orario prenotato
            </p>
          </div>
        )}
      </div>
              ...
              <button
                ...
                className={`p-2 rounded text-sm transition-colors ${
                  selectedTime === slot.time
                    ...
                    : slot.available
                      ? 'bg-gray-100 bg-gray-700 hover:bg-gray-200 hover:bg-gray-600 text-gray-900 text-gray-100'
                      : 'bg-gray-50 bg-gray-800 text-gray-400 text-gray-500 cursor-not-allowed'
                }`}
              >
                {slot.time}
              </button>
      ...
      {selectedDate && selectedTime && selectedCourt && (
        <Section title="Configura Prenotazione" variant="minimal" T={T}>
          <div className={`${T.cardBg} ${T.border} ${T.borderMd} p-6 space-y-6`}>
            {/* Duration */}
            <div>
      ...
      {showPastBookings && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white bg-gray-900 border border-gray-200 border-gray-600 rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto shadow-xl">
              ...
              <div className="space-y-2">
                {pastUserBookings.map((booking) => {
                  ...
                  return (
                    <div
                      key={booking.id}
                      className="bg-gray-50 bg-gray-800 border border-gray-200 border-gray-500 p-3 rounded-md cursor-pointer hover:shadow-md transition-all"
                      onClick={() => showBookingDetails(booking)}
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
      ...
      {selectedBookingDetails && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white bg-gray-900 border border-gray-200 border-gray-600 rounded-lg p-6 max-w-md w-full max-h-[80vh] overflow-y-auto shadow-xl">
            <div className="flex justify-between items-start mb-4">
            ...
            <div className="space-y-4">
              {/* Main info */}
              <div className="bg-gray-50 bg-gray-800 border border-gray-200 border-gray-500 p-4 rounded-md">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    {selectedBookingDetails.players.map((player, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-2 px-3 py-2 bg-gray-50 bg-gray-800 border border-gray-200 border-gray-500 rounded-md"
                      >
                        <div
