...
const NotificationBadge = ({ size = 'md', onClick, showCount = true, className = '' }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = notificationService.subscribeToUnreadCount(currentUser.uid, (count) => {
    ...
    >
      <Bell
        ...
        className={`
          ...
          ${unreadCount > 0 ? 'text-blue-600 text-blue-400' : ''}
        `}
      />
