            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div
                    className={`text-2xl font-bold ${getStatusColor(parseFloat(metrics.cache.hitRate), { good: 80, warning: 60 })}`}
                  >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="font-medium">
                        {formatTime(performanceReport.summary.uptime)}
                      </div>
                    </div>
                    <div>
                    ...
                    {metrics.queries.slice(0, 10).map((query, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2 text-sm">
                          <span
                            className={
                              query.avgTime > 1000 ? 'text-red-600 font-medium' : 'text-green-600'
                            }
                          >
                        ...
                        <td className="px-4 py-2 text-sm">
                          <span
                            className={query.slowQueries > 0 ? 'text-red-600' : 'text-green-600'}
                          >
                            {query.slowQueries}
                          </span>
                        </td>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="text-xl font-bold text-green-700">
                    {metrics.subscriptions.totalMessages}
                  </div>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
