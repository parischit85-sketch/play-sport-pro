        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
              ...
              />
              <label htmlFor="includeMetadata" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
        ...
        <div className="p-6 space-y-4">
          ...
          {validationErrors.length > 0 && (
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              ...
              <ul className="text-sm text-yellow-800 dark:text-yellow-300 list-disc list-inside space-y-1 max-h-40 overflow-y-auto">
