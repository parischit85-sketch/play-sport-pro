  ...
  return (
    <div className={`${T.cardBg} border ${T.border} rounded-lg overflow-hidden`}>
      ...
      <button
        ...
        className={`w-full px-6 py-4 flex items-center justify-between ${T.text} hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors`}
      >
        ...
        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className={`text-sm ${T.muted}`}>
                  ...
                  I dati verranno scaricati sul tuo dispositivo in formato leggibile.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h4 className={`font-medium ${T.text} mb-3`}>
              Seleziona il formato di export:
            </h4>

            {/* JSON Format */}
            <div className="flex items-start gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-400 dark:hover:border-blue-600 transition-colors">
            ...
            {/* CSV Format */}
            <div className="flex items-start gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-green-400 dark:hover:border-green-600 transition-colors">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xl">📊</span>
            ...
            {/* TXT Format */}
            <div className="flex items-start gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-purple-400 dark:hover:border-purple-600 transition-colors">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xl">📝</span>
