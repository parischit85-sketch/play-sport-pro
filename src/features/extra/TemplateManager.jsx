          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                {stats.total} template disponibili ({stats.system} di sistema, {stats.custom} personalizzati)
              </p>
            </div>
            <button
              onClick={onClose}
...
function TemplateCard({ template, isSelected, onSelect, onDelete, T }) {
  ...
  const categoryInfo = {
    weekday: { color: 'blue', bg: 'bg-blue-100 dark:bg-blue-900', text: 'text-blue-700 dark:text-blue-300' },
    weekend: { color: 'purple', bg: 'bg-purple-100 dark:bg-purple-900', text: 'text-purple-700 dark:text-purple-300' },
    seasonal: { color: 'orange', bg: 'bg-orange-100 dark:bg-orange-900', text: 'text-orange-700 dark:text-orange-300' },
    custom: { color: 'green', bg: 'bg-green-100 dark:bg-green-900', text: 'text-green-700 dark:text-green-300' }
  };
  ...
  return (
    ...
    >
      ...
      {/* Selection Indicator */}
      {isSelected && (
        <div className="mt-3 flex items-center justify-center text-blue-600 dark:text-blue-400 font-semibold text-sm">
          ✓ Selezionato
        </div>
      )}
    </div>
                  ...
                  {templateData.timeSlots.map((slot, idx) => (
                    ...
                    >
                      ...
                      <div className="text-gray-600 dark:text-gray-400 text-xs mt-1">
                        ⏰ {slot.from} - {slot.to} | 💰 €{slot.eurPerHour}/h | 📅 {formatDays(slot.days)}
                      </div>
                    </div>
                  ))}
                </div>
