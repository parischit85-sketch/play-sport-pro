...
const PlayerInfoPanel = ({ player, T }) => {
  ...
  return (
    <aside className="hidden xl:block w-80 flex-shrink-0 border-l border-gray-200 border-gray-700 bg-gradient-to-b from-gray-50 to-white from-gray-800/50 to-gray-900/50">
      <div className="sticky top-0 p-6 space-y-6 max-h-screen overflow-y-auto">
        
        {/* Quick Stats Summary */}
        <div className="space-y-3">
          <h3 className="text-sm font-bold text-gray-900 text-white uppercase tracking-wide flex items-center gap-2">
            <span className="text-lg">📊</span>
            Statistiche Rapide
          </h3>
          
          {/* Ranking Trend */}
          <div className="bg-white bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-2xl">📈</span>
                <div>
                  <div className="text-xs text-gray-500 text-gray-400">Ranking</div>
            ...
            <div className="mt-3 h-1 bg-gray-100 bg-gray-700 rounded-full overflow-hidden">
              <div 
          ...
          <div className="bg-white bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-2xl">🎯</span>
                <div>
                  <div className="text-xs text-gray-500 text-gray-400">Win Rate</div>
                  <div className="text-lg font-bold text-gray-900 text-white">
            ...
            {/* Progress bar */}
            <div className="mt-3 h-2 bg-gray-100 bg-gray-700 rounded-full overflow-hidden">
              <div 
          ...
          <div className="bg-white bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-2xl">📅</span>
                <div>
                  <div className="text-xs text-gray-500 text-gray-400">Prenotazioni mese</div>
                  <div className="text-lg font-bold text-gray-900 text-white">
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-xs font-semibold text-gray-900 text-white">
                        {alert.title}
                      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {recentActivity.map((activity, index) => (
                <div 
                  key={index}
                  className="bg-white rounded-lg p-3 shadow-sm border border-gray-100 border-gray-700 hover:shadow-md transition-shadow"
                >
                  <div className="flex items-start gap-2">
                    <span className="text-lg flex-shrink-0">{activity.icon}</span>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <div className="text-xs font-semibold text-gray-900 text-white truncate">
                          {activity.title}
                        </div>
                        <div className="text-xs text-gray-500 text-gray-400 flex-shrink-0">
                          {formatDate(activity.date)}
                        </div>
                      </div>
                      <div className="text-xs text-gray-600 text-gray-400 mt-0.5 truncate">
        ...
        {stats.tournamentActive && (
          <div className="space-y-3">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 from-purple-900/20 to-purple-800/20 rounded-xl p-4 border border-purple-200 border-purple-700">
              ...
              <div className="text-xs text-purple-700 text-purple-300">
                {player.tournamentData?.tournamentName || 'Torneo in corso'}
              </div>
              {player.tournamentData?.ranking && (
                <div className="mt-2 text-xs text-purple-600 text-purple-400">
        ...
        {/* Quick Actions */}
        <div className="space-y-2 pt-4 border-t border-gray-200 border-gray-700">
          ...
          <button className="w-full px-4 py-2 bg-white border border-gray-200 border-gray-700 text-gray-700 text-gray-300 rounded-lg text-xs font-semibold hover:shadow-md transition-shadow">
            📧 Invia Comunicazione
          </button>
        </div>
        ...
        <div className="pt-4 border-t border-gray-200 border-gray-700">
          <div className="text-xs text-gray-500 text-gray-400 space-y-1">
