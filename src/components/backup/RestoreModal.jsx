  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-orange-700 dark:text-orange-300">
                    Il ripristino del backup modificherà i dati nel database.
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Dimensione</p>
                <p className="font-semibold text-gray-900 dark:text-white">
                  {backup.metadata.size} MB
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Versione</p>
                <p className="font-semibold text-gray-900 dark:text-white">
                  {backup.metadata.version}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Origine</p>
                <p className="font-semibold text-gray-900 dark:text-white capitalize">
                  {backup.metadata.source}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Documenti totali</p>
                <p className="font-semibold text-gray-900 dark:text-white">
                  {totalDocuments}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                `}>
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      I dati del backup verranno uniti con quelli esistenti.
                      I documenti esistenti non verranno sovrascritti.
                    </p>
                  </div>
                </label>
                ...
                `}>
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      I documenti esistenti verranno completamente sovrascritti
                      con quelli del backup. Usare con cautela.
                    </p>
                  </div>
                </label>
              </div>
            ...
            {/* Final Confirmation */}
            <label className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg cursor-pointer">
              <input
                type="checkbox"
                checked={confirmed}
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Ho creato un backup recente e comprendo che questa operazione
                  modificherà il database.
                </p>
              </div>
            </label>
          </div>
