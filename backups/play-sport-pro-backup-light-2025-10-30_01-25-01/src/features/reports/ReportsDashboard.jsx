      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="bg-white bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="space-y-2">
              <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 hover:bg-gray-700">
                <input
                  type="radio"
                  name="format"
                  value="excel"
              ...
              <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 hover:bg-gray-700">
                ...
                {reportType !== 'bookings' && (
                  <span className="ml-auto text-xs text-gray-500">Solo per prenotazioni</span>
                )}
              </label>
            </div>
          </div>
          ...
          <div className="bg-white bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="bg-gray-50 bg-gray-700 rounded-lg p-6 mb-6">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600 text-gray-400">Formato:</span>
                  <span className="font-semibold uppercase">{format}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 text-gray-400">Periodo:</span>
                  <span className="font-semibold">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600 text-gray-400">Giorni:</span>
                  <span className="font-semibold">
