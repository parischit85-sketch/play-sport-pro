    ...
    <div className="space-y-3">
      ...
      <label className="flex items-start gap-3 cursor-pointer group">
        <input
          ...
          required
        />
        <span className="text-sm text-neutral-700 dark:text-gray-300 group-hover:text-neutral-900 dark:group-hover:text-white transition-colors">
          Accetto i{' '}
          <a
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
        ...
        <ul className="text-xs text-blue-600 dark:text-blue-400 space-y-1.5 ml-4 list-disc">
          ...
          <li>Puoi richiedere l&apos;accesso, la modifica o la cancellazione dei tuoi dati in qualsiasi momento</li>
      ...
      <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
        <label className="flex items-start gap-3 cursor-pointer group">
          <input
            ...
            className="mt-1 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 cursor-pointer"
          />
          <span className="text-sm text-neutral-600 dark:text-gray-400 group-hover:text-neutral-800 dark:group-hover:text-gray-200 transition-colors">
