  ...
  if (variant === 'dropdown') {
    return (
      <div className="relative">
        ...
        >
          <Globe className={`w-4 h-4 ${size === 'small' ? 'w-3 h-3' : size === 'large' ? 'w-5 h-5' : 'w-4 h-4'}`} />
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-800 dark:text-blue-300">
          La lingua selezionata verrà salvata automaticamente e utilizzata in tutte le sessioni future.
          Puoi cambiarla in qualsiasi momento da questa sezione.
        </p>
      </div>
    </div>
  );
