      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-8">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-neutral-600 dark:text-gray-300 mb-4">{currentTask.description}</p>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex-1 border-2 border-gray-300 dark:border-gray-600 text-neutral-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 py-3 rounded-lg font-semibold transition-colors"
          >
            Salta per ora
          </button>
          <button
        ...
        <div className="mt-8 space-y-2">
          <p className="text-sm font-medium text-neutral-700 dark:text-gray-300 mb-4">
            Tutti i compiti
          </p>
        ...
        <div className="mt-8 text-center">
          <button
            ...
            className="text-sm text-neutral-600 dark:text-gray-400 hover:text-neutral-900 dark:hover:text-white underline transition-colors"
          >
