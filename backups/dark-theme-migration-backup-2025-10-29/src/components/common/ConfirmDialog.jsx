...
const ConfirmDialog = React.memo(function ConfirmDialog({
  ...
  return createPortal(
    ...
    >
      <div
        className={`
          relative w-full max-w-md bg-white dark:bg-gray-900 rounded-lg shadow-2xl
          ...
          {requireTextConfirmation && (
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <code className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-red-600 dark:text-red-400 font-mono">
                  {requireTextConfirmation}
                </code>
              </label>
              <input
                ...
                className="
                  w-full px-4 py-2 border border-gray-300 dark:border-gray-700
