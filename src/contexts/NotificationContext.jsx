...
export const useNotifications = () => {
  ...
  if (!context) {
    ...
    const isTest = (typeof import.meta !== 'undefined' && (import.meta.vitest || (import.meta.env && import.meta.env.MODE === 'test')))
      || (typeof globalThis !== 'undefined' && globalThis.process && (globalThis.process.env?.NODE_ENV === 'test' || globalThis.process.env?.VITEST_WORKER_ID))
