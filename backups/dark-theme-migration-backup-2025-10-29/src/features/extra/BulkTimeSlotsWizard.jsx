            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Fasce di 60 minuti</div>
                </button>
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Fasce di 30 minuti</div>
                </button>
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Intervallo custom</div>
                </button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[0, 1, 2, 3, 4, 5, 6].map((day) => (
                  ...
                  >
                    <div className="font-bold text-gray-900 dark:text-white">{dayNames[day]}</div>
                  </button>
                ))}
              </div>
