...
export const SEGMENT_TEMPLATES = {
  VIP_USERS: {
    ...
    filters: [
      { field: 'bookingCount', operator: '>=', value: 10 }
    ]
  },
  ...
  AT_RISK: {
    ...
    filters: [
      { field: 'lastActivityDays', operator: '>=', value: 30 }
    ]
  },
  ...
  PAYMENT_DUE: {
    ...
    filters: [
      { field: 'hasPendingPayment', operator: '==', value: true }
    ]
  }
};
  ...
  _compareValues(userValue, operator, filterValue) {
    switch (operator) {
      ...
      case SEGMENT_OPERATORS.ARRAY_CONTAINS_ANY:
        return Array.isArray(userValue) && Array.isArray(filterValue) &&
