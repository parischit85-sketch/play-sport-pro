...
import { X, Download, Trash2, AlertTriangle, AlertCircle, Info, XCircle, Filter, RefreshCw } from 'lucide-react';
          ...
          {filteredErrors.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                {errors.length === 0 ? 'Nessun errore registrato' : 'Nessun errore corrisponde ai filtri'}
              </p>
            </div>
          ) : (
                      ...
                      <details className="mt-2">
                        ...
                        <div className="mt-2 space-y-2 text-sm">
                          <div>
                            ...
                            <span className="ml-2 text-gray-600 dark:text-gray-400 font-mono text-xs">{error.id}</span>
                          </div>
                          <div>
                            <span className="font-medium text-gray-700 dark:text-gray-300">URL:</span>
                            <span className="ml-2 text-gray-600 dark:text-gray-400 break-all">{error.context.url}</span>
                          </div>
                          {error.stack && (
                            <div>
