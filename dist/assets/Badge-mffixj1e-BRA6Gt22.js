import{j as e}from"./index-mffixj1e-BL6Q6qVf.js";import"./router-mffixj1e-CUV4LGGe.js";const s={default:"bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300",success:"bg-emerald-100 text-emerald-800 dark:bg-emerald-900/20 dark:text-emerald-400",danger:"bg-rose-100 text-rose-800 dark:bg-rose-900/20 dark:text-rose-400",warning:"bg-amber-100 text-amber-800 dark:bg-amber-900/20 dark:text-amber-400",info:"bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400",primary:"bg-emerald-500 text-black font-medium"},n={xs:"px-1.5 py-0.5 text-xs",sm:"px-2 py-1 text-xs",md:"px-2.5 py-1 text-sm",lg:"px-3 py-1.5 text-sm"};function p({children:d,variant:l="default",size:x="sm",icon:t,removable:m=!1,onRemove:a,T:r}){const o=s[l]||s.default,i=n[x]||n.sm,b=r?.borderMd||"rounded-md",g=r?.transitionFast||"transition-all duration-200";return e.jsxs("span",{className:`
