...
const BADGE_VARIANTS = {
  default: 'bg-gray-100 text-gray-800 bg-gray-800 text-gray-300',
  success: 'bg-emerald-100 text-emerald-800 bg-emerald-900/20 text-emerald-400',
  danger: 'bg-rose-100 text-rose-800 bg-rose-900/20 text-rose-400',
  warning: 'bg-amber-100 text-amber-800 bg-amber-900/20 text-amber-400',
  info: 'bg-blue-100 text-blue-800 bg-blue-900/20 text-blue-400',
