...
export function restoreFromJsonBackup(jsonBackup) {
  try {
    const backup =
      typeof jsonBackup === "string" ? JSON.parse(jsonBackup) : jsonBackup;
    ...
    console.log(
      "🔄 Al prossimo caricamento, verranno utilizzati i tuoi dati reali",
    );
...
export function resetToSeedData() {
  try {
    ...
    console.log(
      "✅ Dati cancellati! Al prossimo caricamento verranno creati i seed data (20 giocatori italiani + 3 campi)",
    );
