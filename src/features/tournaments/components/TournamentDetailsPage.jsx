...
function TournamentDetailsPage({ clubId }) {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="sticky top-0 z-20 border-b border-gray-800 bg-gray-800 shadow-sm">
        <div className="px-3 sm:px-4 py-2 sm:py-3">
          ...
          <nav className="-mx-3 sm:mx-0">
            <div className="flex gap-1 overflow-x-auto border-t border-gray-800 pt-2 px-3 sm:px-0 pb-1 scrollbar-hide snap-x snap-mandatory scroll-smooth">
              {visibleTabs.map((tab) => {
                const Icon = tab.icon;
