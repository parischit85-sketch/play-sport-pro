    ...
    <div className="min-h-screen bg-gray-50 bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 border-gray-600 rounded-md px-3 py-2 bg-white bg-gray-700 text-gray-900 text-white"
          ...
          {/* Contact */}
          <div className="bg-white bg-gray-800 rounded-lg shadow-sm border border-gray-200 border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-gray-900 text-white mb-4">Contatti</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <label
                  ...
                  className="ml-2 text-sm text-gray-700 text-gray-300"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-32 border border-gray-300 border-gray-600 rounded-md px-3 py-2 bg-white bg-gray-700 text-gray-900 text-white"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            <button
              ...
              className="px-4 py-2 text-gray-700 text-gray-300 border border-gray-300 border-gray-600 rounded-md hover:bg-gray-50 hover:bg-gray-700"
            >
              Annulla
            </button>
