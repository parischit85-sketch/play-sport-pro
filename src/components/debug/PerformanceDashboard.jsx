...
import { getPerformanceData, getPerformanceSummary, trackServiceWorkerMetrics } from '../../lib/web-vitals';
...
const PerformanceDashboard = ({ T }) => {
  ...
  const getRatingColor = (rating) => {
    switch (rating) {
      ...
      case 'needs-improvement': return 'text-yellow-600 bg-yellow-100 dark:bg-yellow-900/20 dark:text-yellow-400';
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className={`${T.cardBg} ${T.border} rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto`}>
        {/* Header */}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className={`${T.cardBg} ${T.border} rounded-lg p-4`}>
                  ...
                  <div className="text-2xl font-bold">
                    {serviceWorkerMetrics.networkRequests}
                  </div>
                </div>
                ...
                <div className={`${T.cardBg} ${T.border} rounded-lg p-4`}>
                  ...
                  <div className="text-2xl font-bold">
                    {serviceWorkerMetrics.offlineRequests}
                  </div>
                </div>
