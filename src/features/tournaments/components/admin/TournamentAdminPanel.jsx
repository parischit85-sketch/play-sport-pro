...
const TournamentAdminPanel = ({ clubId, tournament, onUpdate }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      ...
      {/* Current Status */}
      <div className="mb-6">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Stato Attuale</h3>
        <div className="flex items-center space-x-3">
          <span className={`px-3 py-1 rounded-full text-white text-sm font-medium ${statusInfo.color}`}>
            {statusInfo.label}
          </span>
          <span className="text-sm text-gray-600 dark:text-gray-400">{statusInfo.description}</span>
        </div>
      </div>

      {/* Progress Indicators */}
      <div className="mb-6">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Progresso</h3>
        ...
        <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
            {advanceInfo.canAdvance ? (
              ...
              <>
                <p className="text-yellow-600 dark:text-yellow-400 font-medium">⚠ Non ancora pronto</p>
      ...
      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        <h4 className="text-sm font-medium text-blue-900 dark:text-blue-300 mb-2">💡 Suggerimento</h4>
