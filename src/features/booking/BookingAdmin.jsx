      ...
      {message && (
        <div
          className={`p-4 rounded-lg ${
            message.type === 'error'
              ? 'bg-red-100 text-red-800 bg-red-900 text-red-200 border border-red-200'
              : 'bg-emerald-100 text-emerald-800 bg-emerald-900 text-emerald-200 border border-emerald-200'
          }`}
        >
          {message.text}
        </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    {booking.status === BOOKING_STATUS.CONFIRMED && (
                      <button
                        ...
                        className="px-3 py-1 text-sm bg-red-100 text-red-800 bg-red-900 text-red-200 rounded-md hover:bg-red-200 hover:bg-red-800 transition-colors"
                        disabled={isSubmitting}
                      >
                        Cancella
                      </button>
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className={`${ds.bodySm} block mb-1`}>Cliente</label>
            <input
              type="text"
          ...
          <div>
            ...
            <select
              ...
              className={`w-full p-2 ${T.cardBg} ${T.border} ${T.borderMd} focus:outline-none focus:ring-2 ${T.primaryRing}`}
            >
              <option value="court">Campo</option>
        ...
        <div className="grid grid-cols-2 gap-3">
          {selectedCourt && (
            <div className="space-y-2">
              <label className={`${ds.bodySm} block mb-1`}>Extra</label>
          ...
          {formData.isLessonBooking && (
            <div>
              <label className={`${ds.bodySm} block mb-1`}>Partecipanti</label>
              <select
