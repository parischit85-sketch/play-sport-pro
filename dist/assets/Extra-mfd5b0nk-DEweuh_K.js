...
import { j as e, p as z, _ as A } from './index-mfd5b0nk-Di_l6arQ.js';
import { r as k, b as S, c as D } from './router-mfd5b0nk-DvckVtmx.js';
import { S as L } from './Section-mfd5b0nk-D35NiLFM.js';
import { e as F } from './format-mfd5b0nk-DAEZv7Mi.js';
  ...
  async function C() {
    ...
    try {
      const { listLeagues: c } = await A(
          async () => {
            const { listLeagues: v } = await import('./index-mfd5b0nk-Di_l6arQ.js').then(
              ($) => $.w
            );
  ...
  async function b() {
    try {
      const { saveLeague: c } = await A(
          async () => {
            const { saveLeague: v } = await import('./index-mfd5b0nk-Di_l6arQ.js').then(($) => $.w);
            return { saveLeague: v };
          },
          __vite__mapDeps([0, 1, 2, 3, 4])
        ),
  ...
  async function j() {
    ...
    try {
      const { loadLeague: N } = await A(
          async () => {
            const { loadLeague: $ } = await import('./index-mfd5b0nk-Di_l6arQ.js').then((w) => w.w);
            return { loadLeague: $ };
          },
          __vite__mapDeps([0, 1, 2, 3, 4])
        ),
