    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-400">Caricamento configurazioni...</span>
        </div>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-white">Configurazioni Circolo</h1>
                    ...
                    <div className="space-y-4">
                      ...
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                        />
                        <span className="text-sm text-gray-300">Consenti prenotazioni ospiti</span>
                      </label>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="space-y-4">
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                        />
                        <span className="text-sm text-gray-300">Notifiche Email</span>
                      </label>
                      <label className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          ...
                          className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                        />
                        <span className="text-sm text-gray-300">Notifiche SMS</span>
                      </label>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="flex flex-col space-y-4">
                        ...
                        {settings.logoUrl ? (
                          <div className="relative inline-block">
                            <div className="w-48 h-48 border-2 border-gray-600 rounded-xl overflow-hidden bg-gray-800 flex items-center justify-center">
                              <img
                          ...
                          <div className="w-48 h-48 border-2 border-dashed border-gray-600 rounded-xl bg-gray-800 flex flex-col items-center justify-center text-gray-400">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          className="w-16 h-12 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer"
                        />
                        <input
                          type="text"
                          value={settings.primaryColor}
                          ...
                          className="flex-1 px-3 py-2 border border-gray-600 rounded-lg bg-gray-700 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                          placeholder="#3B82F6"
                        />
                      </div>
                    </div>
