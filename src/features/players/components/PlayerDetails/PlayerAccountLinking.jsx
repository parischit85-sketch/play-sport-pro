            ...
            <div className="flex items-center gap-2">
              ...
              {permissions?.canUnlinkAccount && (
                <LoadingButton
                  ...
                  className="ml-2 text-xs px-2 py-1 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors"
                >
                  Scollega
                </LoadingButton>
              )}
            ...
            {!isLinking ? (
              <div className="flex items-center gap-2 justify-end">
                <LoadingButton
                  ...
                  className={`px-4 py-2 text-sm bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors ${T.text}`}
                >
                  🔎 Cerca account
                </LoadingButton>
              </div>
                      ...
                      {filteredAccounts.map((acc) => (
                        ...
                        >
                          ...
                          <LoadingButton
                            ...
                            loading={loadingLink}
                            className="ml-3 px-3 py-1 text-sm bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors flex-shrink-0"
                          >
                            🔗 Collega
                          </LoadingButton>
                        </li>
