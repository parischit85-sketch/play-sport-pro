      ...
      {!isValidating && validation && (
        <>
          ...
          {validation.isDisposable && (
            <div className="flex items-start gap-2 text-xs text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-2">
          ...
          {validation.suggestion && (
            <div className="flex items-start gap-2 text-xs text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-2">
              <span className="text-sm">💡</span>
              <div>
                ...
                <button
                  type="button"
                  onClick={() => {
                    const corrected = email.replace(validation.domain, validation.suggestion.split('@')[1]);
                    onChange?.(corrected);
                  }}
