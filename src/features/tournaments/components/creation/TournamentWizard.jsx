      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">2 giocatori per squadra</div>
          </button>
          ...
          >
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">2-6 giocatori per squadra</div>
          </button>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-800">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Moltiplicatore RPA</label>
            <input
              type="number"
              min="0"
              step="0.1"
              ...
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500"
            />
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Somma dei delta RPA per ogni partita (vittorie +, sconfitte −) × moltiplicatore</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Punti piazzamento girone</label>
        ...
        <div className="mt-4">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Punti avanzamento Eliminazione Diretta (per vittoria)</label>
  ...
  const renderReviewStep = () => (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
        <h3 className="font-semibold text-lg mb-4 text-gray-900 dark:text-white">Riepilogo Torneo</h3>
        ...
        <div className="space-y-3 text-sm">
          ...
          {formData.description && (
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900 dark:text-white">{formData.description.substring(0, 50)}...</span>
            </div>
          )}
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-gray-900 dark:text-white">{formData.numberOfGroups}</span>
          </div>
          
          <div className="flex justify-between">
            <span className="text-gray-600 dark:text-gray-400">Squadre per girone:</span>
            <span className="font-medium text-gray-900 dark:text-white">{formData.teamsPerGroup}</span>
          </div>
          
          <div className="flex justify-between">
            <span className="text-gray-600 dark:text-gray-400">Qualificati per girone:</span>
            <span className="font-medium text-gray-900 dark:text-white">{formData.qualifiedPerGroup}</span>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-gray-900 dark:text-white">{formData.numberOfGroups * formData.teamsPerGroup}</span>
          </div>

          <div className="flex justify-between">
            <span className="text-gray-600 dark:text-gray-400">Ranking default non partecipanti:</span>
            <span className="font-medium text-gray-900 dark:text-white">{formData.defaultRankingForNonParticipants}</span>
          </div>

          <div className="mt-4">
            <div className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Punti Campionato</div>
