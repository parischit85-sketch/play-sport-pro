  ...
  return (
    <div className="h-64 sm:h-80 mb-8 md:mb-12">
      ...
      {showMobilePopup && (
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-sm max-h-[60vh] overflow-hidden animate-slide-up">
            {/* Header */}
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              <button
                onClick={() => setShowMobilePopup(false)}
                className="w-full py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg transition-colors duration-200"
              >
                Chiudi
              </button>
            </div>
