            ...
            <div
              ...
              className={`p-3 rounded-lg cursor-pointer transition-all hover:scale-[1.02] ${
                isExpired
                  ...
                  : daysUntilExpiry <= 15
                    ? 'bg-orange-900/20 hover:bg-orange-900/30 border-l-4 border-orange-500'
                    : status === 'missing'
                      ? 'bg-gray-800 hover:bg-gray-700 border-l-4 border-gray-400'
                      : 'bg-yellow-900/20 hover:bg-yellow-900/30 border-l-4 border-yellow-500'
              }`}
            >
                ...
                <div className="text-right shrink-0">
                  {status === 'missing' ? (
                    <>
                      ...
                      <p className="text-xs text-gray-400">Nessun certificato</p>
                    </>
                  ) : isExpired ? (
                    <>
