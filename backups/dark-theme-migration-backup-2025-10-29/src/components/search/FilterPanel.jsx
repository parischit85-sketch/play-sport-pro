          ...
          <div className="px-4 py-3 space-y-2">
            ...
            {type === 'range' && (
              <div className="space-y-3">
                <div>
                  <label className="text-sm text-gray-600 dark:text-gray-400 mb-1 block">Min</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-sm text-gray-600 dark:text-gray-400 mb-1 block">Max</label>
                  <input
                    type="number"
            ...
            {type === 'toggle' && (
              <label className="flex items-center justify-between cursor-pointer">
                <span className="text-gray-700 dark:text-gray-300">{options.label}</span>
                <input
                  type="checkbox"
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-gray-900 dark:text-white">Filtri</h3>
