  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-[100001] flex items-center justify-center p-4">
        <div
          className={`${T.cardBg} rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden animate-fade-in`}
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-emerald-500 to-blue-600 p-6 relative">
            <button
              onClick={onClose}
            ...
            <h2 id="registration-modal-title" className="text-2xl font-bold text-white mb-2">
              Benvenuto!
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">Registrati come Utente</h3>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">Registra il tuo Circolo</h3>
