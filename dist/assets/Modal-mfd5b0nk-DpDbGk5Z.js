import { j as e } from './index-mfd5b0nk-Di_l6arQ.js';
...
function b({ open: i, isOpen: a, onClose: s, title: n, children: l, T: m, size: o = 'md' }) {
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      e.jsxs('div', {
        className: `relative z-10 rounded-2xl bg-white ring-1 ring-black/10 p-4 lg:p-6 ${r[o]} shadow-2xl max-h-[85vh] md:max-h-[90vh] overflow-y-auto mb-16 md:mb-0`,
        style: { paddingBottom: 'calc(env(safe-area-inset-bottom) + 0.5rem)' },
        children: [
          e.jsxs('div', {
            className: 'flex items-center justify-between mb-4',
            children: [
              e.jsx('h3', { className: 'text-lg font-semibold', children: n }),
              e.jsx('button', {
                type: 'button',
                onClick: s,
