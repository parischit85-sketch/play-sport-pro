              ...
              {testResult && testResult.original && (
                <div className="space-y-4">
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
                    ...
                    <code className="text-sm text-green-800 dark:text-green-400 break-all">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mt-4">
                    <p className="text-sm text-blue-800 dark:text-blue-300">
                      <strong>Result:</strong> First 5 requests allowed, requests 6-7 blocked.
          ...
          {activeTab === 'headers' && (
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                {Object.entries(getSecurityHeaders()).map(([header, value]) => (
                  ...
                  >
                    ...
                    <code className="text-xs text-gray-700 dark:text-gray-300 break-all block bg-white dark:bg-gray-800 p-2 rounded">
                      {value}
                    </code>
                  </div>
                ))}
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4 border border-yellow-200 dark:border-yellow-800">
                ...
                <pre className="text-xs bg-yellow-100 dark:bg-yellow-900/40 p-3 rounded overflow-x-auto">
{`[[headers]]
  for = "/*"
  [headers.values]
