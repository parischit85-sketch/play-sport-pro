...
const BackupPanel = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white bg-gray-800 rounded-xl shadow-lg">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          {backupProgress && (
            <div className="p-4 bg-blue-50 bg-blue-900/20 rounded-lg">
              <div className="flex items-center gap-3 mb-2">
                <Loader size={20} className="text-blue-600 text-blue-400 animate-spin" />
                <span className="text-sm font-medium text-blue-700 text-blue-300">
                  {backupProgress.collection}
                </span>
                <span className="ml-auto text-sm text-blue-600 text-blue-400">
          ...
          {/* Last Backup Info */}
          {lastBackup && (
            <div className="p-4 bg-gray-50 bg-gray-700 rounded-lg">
              <div className="flex items-start gap-3">
                <FileJson size={24} className="text-green-600 text-green-400 flex-shrink-0" />
                <div className="flex-1">
                  ...
                  <dl className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <dt className="text-gray-500 text-gray-400">Dimensione:</dt>
                      <dd className="font-medium text-gray-900 text-white">
                        {lastBackup.metadata.size} MB
                      </dd>
                    </div>
                    <div>
                      <dt className="text-gray-500 text-gray-400">Collezioni:</dt>
                      <dd className="font-medium text-gray-900 text-white">
                        {lastBackup.metadata.collections.length}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-gray-500 text-gray-400">Timestamp:</dt>
                      <dd className="font-medium text-gray-900 text-white">
                        {new Date(lastBackup.metadata.timestamp).toLocaleString('it-IT')}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-gray-500 text-gray-400">Durata:</dt>
                      <dd className="font-medium text-gray-900 text-white">
