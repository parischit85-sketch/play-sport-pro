      ...
      >
        <div className="animate-pulse space-y-4">
          ...
          <div className="space-y-3">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-20 bg-gray-200/40 bg-gray-600/30 rounded-lg"></div>
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredBookings.length === 0 ? (
          ...
          filteredBookings.map((booking) => (
            <div
              key={booking.id}
              className="bg-gradient-to-r from-gray-50/80 to-gray-100/60 from-gray-700/60 to-gray-800/40 backdrop-blur-sm rounded-2xl border border-white/30 border-gray-600/30 p-4 hover:shadow-lg transition-all duration-200"
            >
              ...
              <div className="space-y-2">
                ...
                {booking.notes && (
                  <div className="mt-3 p-3 bg-blue-50/70 bg-blue-900/20 backdrop-blur-sm rounded-lg border border-blue-200/50 border-blue-700/30">
                    ...
                    <div className="text-sm text-blue-800 text-blue-200">{booking.notes}</div>
                  </div>
                )}
              </div>
            </div>
