        ...
        <div className="mb-6">
          <div className="flex gap-2 mb-4">
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-700 border-gray-600 text-white"
          ...
          {existingProfiles.length > 0 && (
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-700 border-gray-600 text-white"
              >
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 text-gray-400">📧 {user.email}</p>
                    {user.phone && (
                      <p className="text-sm text-gray-600 text-gray-400">📱 {user.phone}</p>
                    )}
                    {selectedProfile && (
      ...
      <div className="flex justify-between items-start">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            ...
            {user.isLinked && (
              <span className="px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 bg-blue-900 text-blue-200">
                Collegato
              </span>
            )}
          </div>
          ...
          <div className="space-y-1 text-sm text-gray-600 text-gray-400">
            ...
            {user.mergedData?.rating && <p>⭐ Rating: {user.mergedData.rating}</p>}
          </div>
        </div>
...
const ClubUsersPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900 text-white">Gestione Utenti Club</h1>
        <button
      ...
      {users.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-gray-500 text-gray-400 mb-4">Nessun utente nel club</p>
          <button
            onClick={() => setShowSearchModal(true)}
            className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700"
          >
