  ...
  return (
    <div className="min-h-screen bg-gray-50 bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* Hero Section */}
        <div className="bg-white bg-gray-800 rounded-xl shadow-md overflow-hidden mb-8">
          <div className="p-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          {/* Contact Info */}
          <div className="bg-white bg-gray-800 rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold text-gray-900 text-white mb-4">Contatti</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {club.settings?.allowGuestBookings && (
              <div className="text-center p-3 bg-green-50 bg-green-900/20 rounded-lg">
                ...
                <div className="text-sm font-medium text-green-800 text-green-400">
                  Prenotazioni Ospiti
                </div>
              </div>
            )}
            {club.settings?.autoApproveAffiliations && (
              <div className="text-center p-3 bg-blue-50 bg-blue-900/20 rounded-lg">
                <div className="text-2xl mb-1">⚡</div>
                <div className="text-sm font-medium text-blue-800 text-blue-400">
                  Affiliazione Rapida
                </div>
              </div>
            )}
