        ...
        >
          ...
          {lessonBookings.length > 0 && (
            <Badge variant="primary" size="sm" className="ml-2">
              {
                lessonBookings.filter(
                  (b) => b.status === 'confirmed' && b.createdBy === actualUser?.uid
                ).length
              }
            </Badge>
          )}
                  ...
                  {availableDates.map((dateInfo) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isToday && (
                          <div className="text-xs text-green-400 font-bold mt-1 bg-green-900/50 border border-green-700 rounded-full px-2 py-0.5">
                            OGGI
                          </div>
                        )}
                      </button>
          ...
          {lessonBookings.length === 0 ? (
            ...
            <div className="space-y-4">
              {lessonBookings
                .filter(
                  (booking) =>
                    booking.status === 'confirmed' && booking.createdBy === actualUser?.uid
                )
