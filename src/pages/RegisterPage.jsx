      ...
      <header className={`sticky top-0 z-20 ${T.headerBg}`}>
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <Link to="/" className="h-10 w-auto rounded-md shadow shrink-0 flex items-center hover:opacity-80">
              <img
                src={LOGO_URL}
                alt="Play-Sport.pro"
        ...
        <div className="flex items-center justify-center">
          <div className="max-w-md w-full space-y-8">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              {/* Google Registration Button - Top Priority */}
              {!isGoogleRegistration && (
                <button
                  type="button"
                  onClick={handleGoogleRegistration}
                  disabled={loading}
                  className="w-full bg-white text-gray-700 font-medium py-3 rounded-lg border-2 border-gray-200 hover:border-gray-300 transition-all disabled:opacity-50 flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
                >
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className={`px-2 ${T.cardBg}`}>oppure</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`${T.input} w-full ${errors.email ? 'border-red-500' : ''} ${isGoogleRegistration ? T.inputBg : ''}`}
                    placeholder="Email"
              ...
              <div className="text-center mt-6 pt-6 border-t border-gray-300 dark:border-gray-600">
                <p className={`text-xs ${T.subtext} space-x-4`}>
                  <Link
