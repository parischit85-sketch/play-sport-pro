    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {Object.keys(editErrors).length > 0 && (
          <div className="lg:col-span-2 bg-red-50 bg-red-900/20 border border-red-200 border-red-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <span className="text-red-500 text-xl">⚠️</span>
              <div>
                <h4 className="font-semibold text-red-700 text-red-400 mb-2">
                  Correggi i seguenti errori:
                </h4>
                <ul className="list-disc list-inside space-y-1 text-sm text-red-600 text-red-400">
