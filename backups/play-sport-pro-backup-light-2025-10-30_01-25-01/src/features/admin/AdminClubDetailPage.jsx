        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold text-gray-900 text-white">Dettagli Club</h1>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white bg-gray-800 rounded-lg shadow-sm border border-gray-200 border-gray-700 p-6">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-sm text-gray-500 text-gray-400">ID: {club.id}</div>
            </div>

            {club.description && (
              <p className="text-gray-600 text-gray-400 mt-4">{club.description}</p>
            )}
          </div>
          ...
          <div className="bg-white bg-gray-800 rounded-lg shadow-sm border border-gray-200 border-gray-700 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500 text-gray-400">Membri Totali</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600 text-green-400">
                  {club.stats?.totalCourts || 0}
                </div>
                <div className="text-sm text-gray-500 text-gray-400">Campi</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600 text-purple-400">
                  {club.stats?.monthlyBookings || 0}
                </div>
                <div className="text-sm text-gray-500 text-gray-400">Prenotazioni/Mese</div>
              </div>
            </div>
          </div>
                ...
                {club.contact.email && (
                  <div>
                    ...
                    <a
                      ...
                      className="text-blue-600 text-blue-400 ml-2"
                    >
                      {club.contact.email}
                    </a>
                  </div>
          ...
          <div className="bg-white bg-gray-800 rounded-lg shadow-sm border border-gray-200 border-gray-700 p-6">
            ...
            <div className="space-y-3">
                ...
                <span
                  className={`px-2 py-1 rounded text-sm ${
                    club.settings?.allowPublicBookings
                      ...
                      : 'bg-red-100 text-red-800 bg-red-900 text-red-200'
                  }`}
                >
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-600 text-gray-400">Approvazione richiesta:</span>
                <span
                  className={`px-2 py-1 rounded text-sm ${
          ...
          <div className="bg-white bg-gray-800 rounded-lg shadow-sm border border-gray-200 border-gray-700 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600 text-gray-400">
              <div>
