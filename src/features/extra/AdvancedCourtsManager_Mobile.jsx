      ...
      <div className="relative w-full sm:max-w-2xl bg-white bg-gray-800 rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="px-6 py-6 overflow-y-auto max-h-[calc(90vh-180px)]">
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-3 p-4 bg-emerald-50 bg-emerald-900/30 rounded-xl border-2 border-emerald-200 border-emerald-700">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-emerald-700 text-emerald-300">
                ...
                <div className="text-xs text-emerald-600 text-emerald-400 text-right mt-1">
                  per giocatore
                </div>
              </div>
            </div>
            ...
            {/* Badge Promo */}
            <div className="p-4 bg-yellow-50 bg-yellow-900/20 rounded-xl border-2 border-yellow-200 border-yellow-700">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-yellow-700 text-yellow-300 mt-1">
  ...
  return (
    <>
      <div className={`rounded-2xl ${T.border} ${T.cardBg} overflow-hidden shadow-lg`}>
        ...
        <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 from-blue-900/20 to-purple-900/20">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 flex-wrap mt-1">
                  ...
                  {court.hasHeating && (
                    <span className="text-xs px-2 py-1 rounded-full bg-orange-100 bg-orange-900 text-orange-700 text-orange-300">
                      🔥 Riscald.
                    </span>
                  )}
                </div>
            ...
            <div className="p-4">
              ...
              {activeTab === 'info' && (
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-orange-50 bg-orange-900/20 rounded-xl border-2 border-orange-200 border-orange-700">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        type="checkbox"
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-orange-700 text-orange-300 mt-1">
