...
const NotificationCenter = ({ 
  ...
  const tabs = [
    ...
    { id: 'booking', label: 'Prenotazioni', icon: Calendar, category: NOTIFICATION_CATEGORIES.BOOKING },
    ...
    { id: 'social', label: 'Social', icon: MessageCircle, category: NOTIFICATION_CATEGORIES.SOCIAL },
  ];
  ...
  const handleDeleteAll = async () => {
    ...
    const confirmed = await confirm({
      title: 'Elimina Tutte',
      message: 'Sei sicuro di voler eliminare tutte le notifiche? Questa azione non può essere annullata.',
      variant: 'danger',
    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white dark:bg-gray-900 shadow-2xl">
        <div className="flex flex-col h-full">
          ...
          {/* Tabs */}
          <div className="flex-shrink-0 px-6 py-3 border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
            <div className="flex gap-2">
              {tabs.map((tab) => {
                const Icon = tab.icon;
