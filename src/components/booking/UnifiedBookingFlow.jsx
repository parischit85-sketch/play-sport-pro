            ...
            <div className="space-y-6">
              ...
              <div className="relative max-w-md mx-auto">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 rounded-lg border border-gray-600 bg-gray-700 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400"
                />
              </div>
