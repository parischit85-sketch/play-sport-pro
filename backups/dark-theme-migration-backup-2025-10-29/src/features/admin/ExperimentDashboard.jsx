      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col">
            ...
            <div className="space-y-3">
              {flags.length === 0 ? (
                <div className="text-center py-12">
                  <Flag className="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
          ...
          {activeTab === 'experiments' && (
            <div className="space-y-3">
              {experiments.length === 0 ? (
                <div className="text-center py-12">
                  <FlaskConical className="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
        ...
        {selectedExperiment && (
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full max-h-[80vh] overflow-y-auto p-6">
              ...
              <div className="space-y-4">
                ...
                {Object.entries(selectedExperiment.metrics).map(([variantKey, metrics]) => {
                  ...
                  return (
                    <div key={variantKey} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                      ...
                      {Object.keys(metrics).length === 0 ? (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          {Object.entries(metrics).map(([eventName, count]) => (
                            <div key={eventName} className="bg-white dark:bg-gray-800 rounded p-3">
                              <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">
                                {eventName}
                              </p>
                              <p className="text-lg font-bold text-gray-900 dark:text-white">
