    ...
    <div className="bg-yellow-50 bg-yellow-900/20 border border-yellow-200 border-yellow-800 rounded-lg p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="text-sm font-semibold text-yellow-800 text-yellow-300 mb-2">
            Email non verificata
          </h3>
          <p className="text-sm text-yellow-700 text-yellow-400 mb-3">
            ...
            <div
              className={`mb-3 p-2 rounded text-sm ${
                message.type === 'success'
                  ? 'bg-green-100 bg-green-900/30 text-green-700 text-green-400 border border-green-300 border-green-700'
                  : 'bg-red-100 bg-red-900/30 text-red-700 text-red-400 border border-red-300 border-red-700'
              }`}
            >
              {message.text}
            </div>
          ...
          {/* Help text */}
          <p className="text-xs text-yellow-600 text-yellow-500 mt-3">
