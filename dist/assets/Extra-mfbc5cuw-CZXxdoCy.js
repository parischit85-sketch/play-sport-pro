...
import { j as e, o as z, _ as A } from './index-mfbc5cuw-B5KdbvAg.js';
import { r as k, b as S, c as D } from './router-mfbc5cuw-tw9hraEf.js';
import { S as L } from './Section-mfbc5cuw-CH6um2i6.js';
import { e as F } from './format-mfbc5cuw-DAEZv7Mi.js';
  ...
  async function C() {
    ...
    try {
      const { listLeagues: c } = await A(
          async () => {
            const { listLeagues: v } = await import('./index-mfbc5cuw-B5KdbvAg.js').then(
              ($) => $.v
            );
  ...
  async function b() {
    try {
      const { saveLeague: c } = await A(
          async () => {
            const { saveLeague: v } = await import('./index-mfbc5cuw-B5KdbvAg.js').then(($) => $.v);
            return { saveLeague: v };
          },
          __vite__mapDeps([0, 1, 2, 3, 4])
        ),
  ...
  async function j() {
    ...
    try {
      const { loadLeague: N } = await A(
          async () => {
            const { loadLeague: $ } = await import('./index-mfbc5cuw-B5KdbvAg.js').then((w) => w.v);
            return { loadLeague: $ };
          },
          __vite__mapDeps([0, 1, 2, 3, 4])
        ),
