                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={(e) =>
                          setExportSettings((prev) => ({ ...prev, includeNotes: e.target.checked }))
                        }
                        className="text-blue-600"
                      />
                ...
                {bulkAction.type === 'category' && (
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setBulkAction((prev) => ({ ...prev, category: e.target.value }))
                      }
                      className={`${T.input} w-full`}
                    >
                ...
                {bulkAction.type === 'message' && (
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setBulkAction((prev) => ({ ...prev, message: e.target.value }))
                      }
