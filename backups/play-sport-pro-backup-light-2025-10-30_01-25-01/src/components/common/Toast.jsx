...
const TOAST_STYLES = {
  success: {
    ...
    bg: 'bg-green-50 bg-green-900 bg-green-900/20',
    border: 'border-green-200 border-green-800',
    text: 'text-green-700 text-green-100 text-green-400',
    icon: 'text-green-600 text-green-400',
    progressBg: 'bg-green-500',
  },
  error: {
    bg: 'bg-red-50 bg-red-900 bg-red-900/20',
    border: 'border-red-200 border-red-800',
    text: 'text-red-700 text-red-100 text-red-400',
    icon: 'text-red-600 text-red-400',
    progressBg: 'bg-red-500',
  },
  warning: {
    // Support both amber and legacy yellow classes
    bg: 'bg-amber-50 bg-yellow-50 bg-amber-900 bg-yellow-900 bg-amber-900/20',
    border: 'border-amber-200 border-yellow-200 border-amber-800',
    text: 'text-amber-700 text-yellow-700 text-yellow-100 text-amber-400',
    icon: 'text-amber-600 text-yellow-600 text-amber-400',
    progressBg: 'bg-amber-500 bg-yellow-500',
  },
  info: {
    bg: 'bg-blue-50 bg-blue-900 bg-blue-900/20',
    border: 'border-blue-200 border-blue-800',
    text: 'text-blue-700 text-blue-100 text-blue-400',
    icon: 'text-blue-600 text-blue-400',
    progressBg: 'bg-blue-500',
  },
  loading: {
    bg: 'bg-gray-50 bg-gray-900/20',
...
const Toast = React.memo(function Toast({
  ...
  return (
    ...
    >
                ...
                className={`
                  ...
                  ${
                    action.variant === 'primary'
                      ...
                      : `${styles.text} hover:opacity-70 bg-white/50 bg-black/20`
                  }
                  transition-colors
                `}
              >
      ...
      {/* Progress Bar */}
      {showProgress && duration > 0 && (
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-200 bg-gray-700 rounded-b-lg overflow-hidden">
          <div
...
export const ToastContainer = React.memo(function ToastContainer({
  ...
  const content = (
    ...
    >
      ...
      {hasHiddenToasts && (
        <div className="pointer-events-auto px-3 py-1.5 text-xs font-medium text-gray-600 text-gray-400 bg-gray-100 bg-gray-800 rounded-lg text-center">
