  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-bold text-gray-900 dark:text-white">Vista Pubblica</h3>
      ...
      {isEnabled && (
        <>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white">Vista Smartphone</h4>
              </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white">Vista TV</h4>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-4">
            <h4 className="font-semibold text-gray-900 dark:text-white">Impostazioni</h4>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  showQRCode ? 'bg-primary-600' : 'bg-gray-300 dark:bg-gray-600'
                } disabled:opacity-50`}
              >
                <span
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
            <button
              ...
              className="flex items-center gap-2 text-primary-600 dark:text-primary-400 font-medium hover:underline mb-3"
            >
            ...
            {showQR && (
              <div className="bg-white p-6 rounded-lg inline-block">
                ...
                <p className="text-center text-sm text-gray-600 mt-3">Vista Smartphone</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <RefreshCw className="w-5 h-5 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5" />
