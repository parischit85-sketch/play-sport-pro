    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
          ...
          <button onClick={onClose} className="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-white dark:bg-gray-800">
          ...
          <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <div className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Informazioni Base</div>
          {error && (
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ranking default per non partecipanti</label>
                <input
                  type="number"
                  min={500}
                  max={3000}
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Usato per i giocatori del circolo non iscritti al torneo quando selezionati nelle squadre.</p>
              </div>
            </div>
            <div>
          ...
          <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <div className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Configurazione Gironi</div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Gironi</label>
                <input
                  type="number"
                  min={1}
                  max={16}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Squadre/Girone</label>
                <input
                  type="number"
                  min={2}
                  max={12}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Qualificati/Girone</label>
                <input
                  type="number"
                  min={1}
                  max={8}
            ...
            <div className="flex items-center gap-2 mt-3">
              ...
              />
              <label htmlFor="includeThirdPlaceMatch" className="text-sm text-gray-700 dark:text-gray-300">
          ...
          <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Piazzamento Girone</label>
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Eliminazione Diretta (per vittoria)</label>
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
          <button onClick={onClose} className="px-4 py-2 rounded-lg bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
            Annulla
          </button>
          <button
            onClick={handleSave}
