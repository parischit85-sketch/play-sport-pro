    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {players.length === 0 ? (
          ...
          >
            ...
            <h3 className={`text-lg font-semibold ${T?.text || 'text-gray-900'} mb-2`}>
            ...
            >
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className={`font-semibold ${T?.text || 'text-gray-900'} truncate`}>
                    {player.name ||
                      `${player.firstName || ''} ${player.lastName || ''}`.trim() ||
                      'Senza nome'}
                  </h3>
                  <p className={`text-sm ${T?.subtext || 'text-gray-600'} truncate`}>
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className={`${T?.cardBg || 'bg-white'} rounded-xl w-full max-w-md p-6`}>
            <h2 className={`text-xl font-bold ${T?.text || 'text-gray-900'} mb-4`}>
