...
export function getErrorMessage(error, context = '') {
  ...
  const messages = {
    ...
    [FIRESTORE_ERROR_CODES.UNAVAILABLE]: 'Servizio temporaneamente non disponibile. Riprova più tardi.',
    ...
    [FIRESTORE_ERROR_CODES.RESOURCE_EXHAUSTED]: 'Servizio temporaneamente sovraccarico. Riprova più tardi.',
    [FIRESTORE_ERROR_CODES.DEADLINE_EXCEEDED]: 'Richiesta scaduta. Controlla la connessione di rete.',
