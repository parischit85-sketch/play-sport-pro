...
export const validatePlayers = (a1, a2, b1, b2) => {
  ...
  if (!a1) errors.a1 = { type: FIELD_VALIDATIONS.PLAYER_REQUIRED, message: 'Seleziona giocatore A1' };
  if (!a2) errors.a2 = { type: FIELD_VALIDATIONS.PLAYER_REQUIRED, message: 'Seleziona giocatore A2' };
  if (!b1) errors.b1 = { type: FIELD_VALIDATIONS.PLAYER_REQUIRED, message: 'Seleziona giocatore B1' };
  if (!b2) errors.b2 = { type: FIELD_VALIDATIONS.PLAYER_REQUIRED, message: 'Seleziona giocatore B2' };
