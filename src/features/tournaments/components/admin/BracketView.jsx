...
const BracketView = ({ clubId, tournamentId, onMatchClick }) => {
  ...
  if (knockoutMatches.length === 0) {
    return (
      <div className="p-8 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-center">
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Tabellone Eliminatorio</h2>
          {/* ✅ LIVE Indicator */}
          {isLive && (
          ...
          {orderedRounds.map((round, roundIndex) => (
            <div key={round.name} className="flex flex-col space-y-4" style={{ minWidth: '280px' }}>
              ...
              <div className="text-center mb-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{round.name}</h3>
              ...
              >
                {round.matches.map((match) => (
                  <div
                    ...
                    className={`bg-gray-50 dark:bg-gray-700 border-2 rounded-lg p-4 transition-all ${
