          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-2">
                <span
                  className={`px-3 py-1 rounded-full text-sm font-medium bg-gray-100 bg-gray-700 ${getCategoryColor(player.category)}`}
                >
                  {getCategoryLabel(player.category)}
                </span>

                {!player.isActive && (
                  <span className="px-3 py-1 rounded-full text-sm font-medium bg-red-100 bg-red-900/20 text-red-600 text-red-400">
                    Inattivo
                  </span>
                )}
              </div>

              <div className="space-y-1 text-sm text-gray-600 text-gray-400">
                {player.email && (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
              <div className="text-center">
                {player.tournamentData?.isParticipant && player.tournamentData?.isActive ? (
                  ...
                  <>
                    <div className="text-2xl font-bold text-gray-400 text-gray-600">-</div>
                ...
                <>
                  ...
                  <button
                    ...
                    className={`px-3 py-1 text-sm rounded ${
                      player.isActive
                        ? 'bg-orange-100 bg-orange-900/20 text-orange-600 text-orange-400'
                        : 'bg-green-100 bg-green-900/20 text-green-600 text-green-400'
                    }`}
                  >
            ...
            <div className="flex items-center gap-3">
              ...
              {player.isAccountLinked ? (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-green-600 text-green-400">
                    ...
                    {accounts.length > 0 ? (
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => setAccounts([])}
                            className="px-3 py-1 text-sm bg-gray-100 bg-gray-700 text-gray-600 text-gray-400 rounded"
                          >
                            Chiudi elenco
                          </button>
                        </div>
                              ...
                              {filteredAccounts.map((acc) => (
                                <li key={acc.uid} className="p-3 flex items-center justify-between">
                                  ...
                                  <button
                                    ...
                                    className="px-3 py-1 text-sm bg-green-100 bg-green-900/20 text-green-600 text-green-400 rounded ml-3 flex-shrink-0"
                                  >
                                    Collega
                                  </button>
                                </li>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1 text-sm bg-green-100 bg-green-900/20 text-green-600 text-green-400 rounded"
                        >
                          Collega
                        </button>
                        <button
            ...
            <button
              ...
              className={`py-2 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${
                activeTab === tab.id
                  ...
                  : 'border-transparent text-gray-500 text-gray-400 hover:text-gray-700 hover:text-gray-300'
              }`}
            >
                  ...
                  {player.tournamentData?.isParticipant && player.tournamentData?.isActive ? (
                    <>
                      <div className="flex justify-between">
                        ...
                        <span className="text-orange-600 text-orange-400 font-semibold">
                        ...
                        <span
                          className={
                            ...
                            (player.tournamentData.initialRanking || 0)
                              ? 'text-green-600 text-green-400 font-semibold'
                              : (playerWithRealRating.rating || 0) <
                                  (player.tournamentData.initialRanking || 0)
                                ? 'text-red-600 text-red-400 font-semibold'
                                : T.text
                          }
                        >
                          {(playerWithRealRating.rating || 0) -
                    ...
                    <div className="flex flex-wrap gap-2">
                      {player.tags && player.tags.length > 0 ? (
                        player.tags.map((tag) => (
                          <span
                            key={tag}
                            className="px-2 py-1 bg-blue-100 bg-blue-900/20 text-blue-700 text-blue-300 text-xs rounded-full"
                          >
                            {tag}
                          </span>
                        ))
