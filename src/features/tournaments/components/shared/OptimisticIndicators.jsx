...
export function SavingIndicator({ message = 'Salvataggio...', age = null }) {
  return (
    <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
      ...
      <span className="text-sm font-medium text-blue-700 dark:text-blue-300">{message}</span>
      {age !== null && (
        <span className="text-xs text-blue-500 dark:text-blue-400">({(age / 1000).toFixed(1)}s)</span>
      )}
    </div>
  );
}
...
export function OptimisticBadge({ isPending, age = null }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 rounded-full text-xs font-medium text-blue-700 dark:text-blue-300">
  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between mb-1">
        <span className="text-xs font-medium text-blue-700 dark:text-blue-300">Salvataggio in corso...</span>
        <span className="text-xs font-medium text-blue-700 dark:text-blue-300">{Math.round(currentProgress)}%</span>
      </div>
  ...
  return (
    <div className="relative">
      ...
      {showIndicator && isPending && (
        <div className="absolute inset-0 bg-blue-50/50 dark:bg-blue-900/10 backdrop-blur-[1px] rounded-lg flex items-center justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg px-4 py-3">
