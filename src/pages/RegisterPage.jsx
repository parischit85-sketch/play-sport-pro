        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            {!isGoogleRegistration && (
              <>
                <div>
                  <label htmlFor="password" className={`block text-sm font-medium ${T.text} mb-1`}>
                    Password *
                  </label>
                  <input
                    id="password"
                ...
                <div>
                  <label htmlFor="confirmPassword" className={`block text-sm font-medium ${T.text} mb-1`}>
                    Conferma Password *
                  </label>
                  <input
                    id="confirmPassword"
            ...
            <div className="pt-4 border-t border-emerald-400/50 dark:border-gray-600">
              <h3 className={`text-sm font-medium ${T.text} mb-3`}>Informazioni aggiuntive (facoltative)</h3>
              
              <div className="space-y-3">
                <div>
                  <label htmlFor="fiscalCode" className={`block text-sm font-medium ${T.subtext} mb-1`}>
                    Codice fiscale
                  </label>
                  <input
                    id="fiscalCode"
                ...
                <div>
                  <label htmlFor="birthDate" className={`block text-sm font-medium ${T.subtext} mb-1`}>
                    Data di nascita
                  </label>
                  <input
                    id="birthDate"
                ...
                <div>
                  <label htmlFor="address" className={`block text-sm font-medium ${T.subtext} mb-1`}>
                    Indirizzo
                  </label>
                  <input
                    id="address"
          ...
          <div className="space-y-4">
            ...
            >
              {loading ? "Registrazione in corso..." : isGoogleRegistration ? "Completa registrazione" : "Registrati"}
            </button>
          ...
          <div className="text-center">
            <p className={`text-sm ${T.subtext}`}>
              Hai già un account?{" "}
              <Link to="/login" className={`font-medium ${T.text} hover:${T.neonText} transition-colors duration-200`}>
                Accedi qui
              </Link>
            </p>
          </div>
