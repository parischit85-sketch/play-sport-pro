        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <button
              ...
              className="group relative overflow-hidden bg-gradient-to-br from-emerald-50 to-green-50 from-emerald-900/20 to-green-900/10 rounded-xl p-6 border-2 border-emerald-200 border-emerald-700/30 hover:border-emerald-400 hover:border-emerald-500 transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mt-4 flex items-center justify-center gap-2 text-emerald-600 text-emerald-400 font-semibold">
            ...
            <button
              ...
              className="group relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 from-blue-900/20 to-indigo-900/10 rounded-xl p-6 border-2 border-blue-200 border-blue-700/30 hover:border-blue-400 hover:border-blue-500 transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mt-4 flex items-center justify-center gap-2 text-blue-600 text-blue-400 font-semibold">
          ...
          {/* Footer note */}
          <div className="mt-6 text-center text-sm text-gray-500 text-gray-400">
