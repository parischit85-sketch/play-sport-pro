...
const LessonBookingPage = React.lazy(
  () => import("@pages/LessonBookingPage.jsx"),
);
const UnifiedBookingFlow = React.lazy(
  () => import("@components/booking/UnifiedBookingFlow.jsx"),
);
...
const AdminBookingsPage = React.lazy(
  () => import("@pages/AdminBookingsPage.jsx"),
);
const DarkModeTestPage = React.lazy(
  () => import("@pages/DarkModeTestPage.jsx"),
);
