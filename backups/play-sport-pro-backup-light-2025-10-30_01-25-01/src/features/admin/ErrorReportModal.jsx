...
const ErrorReportModal = ({ isOpen, onClose, T }) => {
  ...
  const getSeverityColor = (severity) => {
    switch (severity) {
      case ErrorSeverity.CRITICAL:
        return 'bg-red-100 text-red-800 bg-red-900/30 text-red-300';
      case ErrorSeverity.HIGH:
        return 'bg-orange-100 text-orange-800 bg-orange-900/30 text-orange-300';
      case ErrorSeverity.MEDIUM:
  ...
  const getCategoryColor = (category) => {
    switch (category) {
      case ErrorCategory.NETWORK:
        return 'bg-purple-100 text-purple-800 bg-purple-900/30 text-purple-300';
      ...
      <div className="bg-white bg-gray-800 rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 text-white">Error Reports</h2>
          ...
          <div className="p-6 border-b border-gray-200 border-gray-700">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="bg-gray-50 bg-gray-700/50 rounded-lg p-4">
                <p className="text-sm text-gray-600 text-gray-400 mb-1">Totale</p>
                <p className="text-2xl font-bold text-gray-900 text-white">{stats.total}</p>
              </div>
              <div className="bg-red-50 bg-red-900/20 rounded-lg p-4">
                <p className="text-sm text-red-600 text-red-400 mb-1">Critici</p>
                <p className="text-2xl font-bold text-red-900 text-red-300">
                  {stats.bySeverity[ErrorSeverity.CRITICAL] || 0}
                </p>
              </div>
              <div className="bg-orange-50 bg-orange-900/20 rounded-lg p-4">
                <p className="text-sm text-orange-600 text-orange-400 mb-1">Alta Priorità</p>
                <p className="text-2xl font-bold text-orange-900 text-orange-300">
        ...
        {/* Filters */}
        <div className="p-6 border-b border-gray-200 border-gray-700 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              onClick={loadErrors}
              className="flex items-center gap-2 px-4 py-2 bg-gray-200 bg-gray-700 text-gray-700 text-gray-300 rounded-lg font-medium hover:bg-gray-300 hover:bg-gray-600 transition-colors"
            >
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {filteredErrors.length === 0 ? (
            <div className="text-center py-12">
              <AlertCircle className="w-16 h-16 text-gray-400 text-gray-600 mx-auto mb-4" />
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-start justify-between gap-4 mb-2">
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-900 text-white mb-1 break-words">
                            {error.message}
                          </h4>
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {error.code && (
                              <span className="px-2 py-1 rounded text-xs font-medium bg-gray-200 bg-gray-600 text-gray-800 text-gray-200">
                                {error.code}
                              </span>
                            )}
                          </div>
                        </div>
                        <span className="text-sm text-gray-500 text-gray-400 whitespace-nowrap">
                      ...
                      <details className="mt-2">
                        <summary className="cursor-pointer text-sm text-blue-600 text-blue-400 hover:underline">
                          Mostra Dettagli
                        </summary>
