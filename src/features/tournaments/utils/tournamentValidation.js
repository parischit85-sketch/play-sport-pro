...
export function validateStatusTransition(currentStatus, newStatus) {
  const allowedTransitions = {
    ...
    [TOURNAMENT_STATUS.COMPLETED]: [TOURNAMENT_STATUS.KNOCKOUT_PHASE], // Allow reactivation
    [TOURNAMENT_STATUS.CANCELLED]: [TOURNAMENT_STATUS.DRAFT], // Allow reopening as draft
  };
