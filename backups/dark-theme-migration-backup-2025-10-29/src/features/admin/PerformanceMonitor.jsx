        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <h3
                  className={`font-semibold ${stats.errors.count > 0 ? 'text-red-900 dark:text-red-300' : 'text-gray-900 dark:text-gray-300'}`}
                >
                  Errors
                </h3>
              ...
              <div
                className={`text-3xl font-bold ${stats.errors.count > 0 ? 'text-red-900 dark:text-red-100' : 'text-gray-900 dark:text-gray-100'}`}
              >
                {stats.errors.count}
              </div>
              <div
                className={`text-sm mt-1 ${stats.errors.count > 0 ? 'text-red-700 dark:text-red-400' : 'text-gray-700 dark:text-gray-400'}`}
              >
                Error Rate: {stats.errors.errorRate.toFixed(2)}%
              </div>
              <div
                className={`text-xs mt-1 ${stats.errors.count > 0 ? 'text-red-600 dark:text-red-500' : 'text-gray-600 dark:text-gray-500'}`}
              >
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <h3
                  className={`font-semibold ${stats.firestore.estimatedCost.withinFreeTier ? 'text-purple-900 dark:text-purple-300' : 'text-orange-900 dark:text-orange-300'}`}
                >
                  Firestore
                </h3>
                <span className="text-2xl">🔥</span>
              ...
              <div
                className={`text-3xl font-bold ${stats.firestore.estimatedCost.withinFreeTier ? 'text-purple-900 dark:text-purple-100' : 'text-orange-900 dark:text-orange-100'}`}
              >
                ${stats.firestore.estimatedCost.total.toFixed(4)}
              </div>
              <div
                className={`text-sm mt-1 ${stats.firestore.estimatedCost.withinFreeTier ? 'text-purple-700 dark:text-purple-400' : 'text-orange-700 dark:text-orange-400'}`}
              >
                Reads: {stats.firestore.reads.toLocaleString()}
              </div>
              <div
                className={`text-xs mt-1 ${stats.firestore.estimatedCost.withinFreeTier ? 'text-purple-600 dark:text-purple-500' : 'text-orange-600 dark:text-orange-500'}`}
              >
