...
const ProfileDropdown = ({ onProfileClick, onBackupClick: _onBackupClick }) => {
  return (
    <button
    ...
    >
      ...
      <div className="relative">
        <div className="bg-gradient-to-r from-slate-900/40 to-gray-900/30 text-slate-400 border border-gray-600/20 w-12 h-12 backdrop-blur-sm rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform mx-auto shadow-lg">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <circle cx="12" cy="7" r="4" strokeWidth={1.5} />
            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" strokeWidth={1.5} />
          </svg>
        </div>
        <h3 className="font-bold text-base mb-2 text-white text-center">Profilo</h3>
