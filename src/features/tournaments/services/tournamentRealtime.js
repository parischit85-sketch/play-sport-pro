...
export function subscribeMatches(clubId, tournamentId, filters = {}, callback) {
  const matchesRef = collection(db, 'clubs', clubId, COLLECTIONS.TOURNAMENTS, tournamentId, COLLECTIONS.MATCHES);
...
export function subscribeTeams(clubId, tournamentId, callback) {
  const teamsRef = collection(db, 'clubs', clubId, COLLECTIONS.TOURNAMENTS, tournamentId, COLLECTIONS.TEAMS);
