        ...
        <div className="space-y-3">
          {backupHistory.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 dark:text-gray-400">Nessun backup trovato</p>
            </div>
          ) : (
            backupHistory.map((backup) => (
              <div key={backup.id} className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      {backup.collections?.map((coll) => (
                        <span
                          key={coll}
                          className="px-2 py-0.5 text-xs bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded border border-gray-200 dark:border-gray-600"
                        >
                          {coll}
                        </span>
                      ))}
        ...
        <div className="space-y-3">
          {restoreHistory.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 dark:text-gray-400">Nessun restore eseguito</p>
            </div>
          ) : (
            restoreHistory.map((restore) => (
              <div key={restore.id} className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="flex items-start gap-3">
