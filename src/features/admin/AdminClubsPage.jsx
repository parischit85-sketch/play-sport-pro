...
const ClubCard = ({ club, onEdit, onDelete, onViewDetails }) => {
  ...
  return (
    <div className="bg-white bg-gray-800 rounded-lg shadow-sm border border-gray-200 border-gray-700 p-6 hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <h3 className="text-lg font-semibold text-gray-900 text-white">{club.name}</h3>
            <span
          ...
          <div className="flex gap-4 text-sm text-gray-500 text-gray-400">
        ...
        <div className="flex gap-2 ml-4">
          ...
          <button
            ...
            className="text-gray-600 hover:text-gray-800 text-gray-400 hover:text-gray-300 text-sm px-3 py-1 rounded border border-gray-200 hover:bg-gray-50 border-gray-600 hover:bg-gray-700"
          >
            Modifica
          </button>
          <button
            onClick={() => onDelete(club.id)}
            className="text-red-600 hover:text-red-800 text-red-400 hover:text-red-300 text-sm px-3 py-1 rounded border border-red-200 hover:bg-red-50 border-red-600 hover:bg-red-900/20"
          >
            Elimina
          </button>
        </div>
      ...
      {club.description && (
        <p className="text-sm text-gray-600 text-gray-400 mt-3 pt-3 border-t border-gray-100 border-gray-700">
      ...
      <div className="mt-4 pt-3 border-t border-gray-100 border-gray-700 flex justify-between items-center text-xs text-gray-500 text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold text-gray-900 text-white">Gestione Club</h1>
            </div>
            <button
